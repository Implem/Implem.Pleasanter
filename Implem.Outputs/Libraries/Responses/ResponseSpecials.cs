...
namespace Implem.Pleasanter.Libraries.Responses
{
    ...
    public static class ResponseCollectionSpecials
    {
        ...
        public static UsersResponseCollection ChangedPasswordValidation(this UsersResponseCollection responseCollection) { return responseCollection.Val("#Users_ChangedPasswordValidation", responseCollection.UserModel.ChangedPasswordValidation.ToResponse()); }
        public static UsersResponseCollection ChangedPasswordValidation(this UsersResponseCollection responseCollection, string value) { return responseCollection.Val("#Users_ChangedPasswordValidation", value); }
        public static UsersResponseCollection ChangedPasswordValidation_FormData(this UsersResponseCollection responseCollection) { return responseCollection.ValAndFormData("#Users_ChangedPasswordValidation", responseCollection.UserModel.ChangedPasswordValidation.ToResponse()); }
        public static UsersResponseCollection ChangedPasswordValidation_FormData(this UsersResponseCollection responseCollection, string value) { return responseCollection.ValAndFormData("#Users_ChangedPasswordValidation", value); }
        ...
        public static UsersResponseCollection AfterResetPasswordValidation(this UsersResponseCollection responseCollection) { return responseCollection.Val("#Users_AfterResetPasswordValidation", responseCollection.UserModel.AfterResetPasswordValidation.ToResponse()); }
        public static UsersResponseCollection AfterResetPasswordValidation(this UsersResponseCollection responseCollection, string value) { return responseCollection.Val("#Users_AfterResetPasswordValidation", value); }
        public static UsersResponseCollection AfterResetPasswordValidation_FormData(this UsersResponseCollection responseCollection) { return responseCollection.ValAndFormData("#Users_AfterResetPasswordValidation", responseCollection.UserModel.AfterResetPasswordValidation.ToResponse()); }
        public static UsersResponseCollection AfterResetPasswordValidation_FormData(this UsersResponseCollection responseCollection, string value) { return responseCollection.ValAndFormData("#Users_AfterResetPasswordValidation", value); }
