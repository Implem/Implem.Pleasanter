                ...
                switch (controlId)
                {
                    case "DataViewFilters_Incomplete":
                        sqlWhereCollection.Add(
                            ...
                            name: "_U",
                            _operator: " <> {0}".Params(Parameters.CompletionCode));
                        break;
            ...
            FormData formData)
        {
            formData.Keys.ForEach(key =>
            {
                switch (key)
                {
                    ...
                    case "DataViewFilters_SysLogs_OnAzure": where.SysLogs_OnAzure(formData[key], "t0"); break;
                    ...
                    case "DataViewFilters_SysLogs_InDebug": where.SysLogs_InDebug(formData[key], "t0"); break;
                    ...
                    case "DataViewFilters_Users_Disabled": where.Users_Disabled(formData[key], "t0"); break;
                    ...
                    case "DataViewFilters_Users_TenantAdmin": where.Users_TenantAdmin(formData[key], "t0"); break;
                    case "DataViewFilters_Users_ServiceAdmin": where.Users_ServiceAdmin(formData[key], "t0"); break;
                    case "DataViewFilters_Users_Developer": where.Users_Developer(formData[key], "t0"); break;
                    ...
                    case "DataViewFilters_SearchWords_Word": where.SearchWords_Word(formData[key], "t0"); break;
                    case "DataViewFilters_SearchWords_ReferenceId": where.SearchWords_ReferenceId(formData[key], "t0"); break;
                    case "DataViewFilters_SearchWords_Ver": where.SearchWords_Ver(formData[key], "t0"); break;
                    case "DataViewFilters_SearchWords_Priority": where.SearchWords_Priority(formData[key], "t0"); break;
                    case "DataViewFilters_SearchWords_ReferenceType": where.SearchWords_ReferenceType(formData[key], "t0"); break;
                    case "DataViewFilters_SearchWords_Title": where.SearchWords_Title(formData[key], "t0"); break;
                    case "DataViewFilters_SearchWords_Subset": where.SearchWords_Subset(formData[key], "t0"); break;
                    case "DataViewFilters_SearchWords_PermissionType": where.SearchWords_PermissionType(formData[key], "t0"); break;
                    case "DataViewFilters_SearchWords_Comments": where.SearchWords_Comments(formData[key], "t0"); break;
                    case "DataViewFilters_SearchWords_Creator": where.SearchWords_Creator(formData[key], "t0"); break;
                    case "DataViewFilters_SearchWords_Updator": where.SearchWords_Updator(formData[key], "t0"); break;
                    case "DataViewFilters_SearchWords_CreatedTime": where.SearchWords_CreatedTime(formData[key], "t0"); break;
                    case "DataViewFilters_SearchWords_UpdatedTime": where.SearchWords_UpdatedTime(formData[key], "t0"); break;
                    ...
                    case "DataViewFilters_ExportSettings_AddHeader": where.ExportSettings_AddHeader(formData[key], "t0"); break;
                    ...
                    case "DataViewFilters_Images_ImageId": where.Images_ImageId(formData[key], "t0"); break;
                    case "DataViewFilters_Images_Ver": where.Images_Ver(formData[key], "t0"); break;
                    case "DataViewFilters_Images_Title": where.Images_Title(formData[key], "t0"); break;
                    case "DataViewFilters_Images_Body": where.Images_Body(formData[key], "t0"); break;
                    case "DataViewFilters_Images_Bin": where.Images_Bin(formData[key], "t0"); break;
                    case "DataViewFilters_Images_FileName": where.Images_FileName(formData[key], "t0"); break;
                    case "DataViewFilters_Images_Extension": where.Images_Extension(formData[key], "t0"); break;
                    case "DataViewFilters_Images_Size": where.Images_Size(formData[key], "t0"); break;
                    case "DataViewFilters_Images_ImageSettings": where.Images_ImageSettings(formData[key], "t0"); break;
                    case "DataViewFilters_Images_Comments": where.Images_Comments(formData[key], "t0"); break;
                    case "DataViewFilters_Images_Creator": where.Images_Creator(formData[key], "t0"); break;
                    case "DataViewFilters_Images_Updator": where.Images_Updator(formData[key], "t0"); break;
                    case "DataViewFilters_Images_CreatedTime": where.Images_CreatedTime(formData[key], "t0"); break;
                    case "DataViewFilters_Images_UpdatedTime": where.Images_UpdatedTime(formData[key], "t0"); break;
