...
namespace Implem.Pleasanter.Models
{
    public class ResultModel : BaseItemModel
    {
            ...
            bool paramAll = false)
        {
            ...
            SiteInfo.ItemUpdatedCollection.Add(
                ResultId + "," + DateTime.Now.ToString("yyyy/M/d H:m:s.fff"));
        ...
        public string DeleteComment()
        {
            ...
            if (Rds.ExecuteScalar_int(
                ...
                statements: Rds.UpdateResults(
                    verUp: VerUp,
                    where: Rds.ResultsWhereDefault(this)
                        .UpdatedTime(Forms.DateTime("Results_Timestamp")),
                    param: Rds.ResultsParamDefault(this),
                    countRecord: true)) == 0)
            {
            ...
            SiteInfo.ItemUpdatedCollection.Add(
                ResultId + "," + DateTime.Now.ToString("yyyy/M/d H:m:s.fff"));
            return ResponseByUpdate(new ResultsResponseCollection(this))
            ...
            ResultModel resultModel, Message message = null, bool pushState = true)
        {
            ...
            return new ResultsResponseCollection(this)
                ...
                .Message(message)
                .PushState(
                    Navigations.Get("Items", ResultId.ToString(), "Reload"),
                    Navigations.Edit("Items", resultModel.ResultId),
                    _using: pushState)
                .ClearFormData()
                .ToJson();
        }
    ...
    public class ResultSubset
    {
        ...
        public Dictionary<string, int> SearchWordCollection()
        {
            ...
            ResultId.SearchWords(ref searchWordHash, 1);
