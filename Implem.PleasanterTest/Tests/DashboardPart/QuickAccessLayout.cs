    ...
    public class QuickAccessLayout
    {
        ...
        public static IEnumerable<object[]> GetData()
        {
            ...
            var testParts = new List<TestPart>()
            {
                ...
                //「Urlが指定されていない」「参照先がサイト」「参照先がダッシュボード」「参照先がWiki」「参照先がテーブル」
                new TestPart(
                    baseTests: BaseData.Tests(
                        // ダッシュボードパーツの確認
                        ...
                        // 参照先がダッシュボードであることの確認
                        HtmlData.TextContains(selector: "#DashboardPartLayouts", value: "dashboard-part-nav-item dashboard-part-nav-dashboard"),
                        // 参照先がWikiであることの確認
                        HtmlData.TextContains(selector: "#DashboardPartLayouts", value: "dashboard-part-nav-item dashboard-part-nav-wiki"),
                        // 参照先がテーブルであることの確認
                        HtmlData.TextContains(selector: "#DashboardPartLayouts", value: "dashboard-part-nav-item dashboard-part-nav-table")))
            };
