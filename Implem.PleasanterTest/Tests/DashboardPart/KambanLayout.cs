...
{
    [Collection(nameof(KambanLayout))]
    public class KambanLayout
    {
        [Theory]
            ...
            var testParts = new List<TestPart>()
            {
                ...
                new TestPart(
                    baseTests: BaseData.Tests(
                        ...
                        HtmlData.TextContains(
                            selector: "#DashboardPartLayouts",
                            value: "DashboardPart_12"))),
                new TestPart(
                    baseTests: BaseData.Tests(
                        //// ダッシュボードパーツの確認
                        HtmlData.TextContains(
                            selector: "#DashboardPartLayouts",
                            value: "DashboardPart_13"),
                        HtmlData.TextContains(selector: "#DashboardPartLayouts", value: "DashboardPart_13"))),
             };
