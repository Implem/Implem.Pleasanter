...
{
    [Collection(nameof(TimeLineLayout))]
            ...
            var testParts = new List<TestPart>()
            {
                ...
                new TestPart(
                    baseTests: BaseData.Tests(
                        ...
                        HtmlData.TextContains(
                            selector: "#DashboardPartLayouts",
                            value: "DashboardPart_4"))),
                new TestPart(
                    baseTests: BaseData.Tests(
                        //// ダッシュボードパーツの確認
                        HtmlData.TextContains(
                            selector: "#DashboardPartLayouts",
                            value: "DashboardPart_5"),
                        HtmlData.TextContains(selector: "#DashboardPartLayouts", value: "DashboardPart_5"))),
             };
