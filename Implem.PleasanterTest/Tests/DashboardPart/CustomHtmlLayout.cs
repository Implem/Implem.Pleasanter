...
{
    [Collection(nameof(CustomHtmlLayout))]
    public class CustomHtmlLayout
    {
        ...
        public static IEnumerable<object[]> GetData()
        {
            ...
            var testParts = new List<TestPart>()
            {
                ...
                // テスト
                //「タイトルを表示する：true」「カスタムHTMLが設定されている」
                new TestPart(
                    baseTests: BaseData.Tests(
                        // ダッシュボードパーツの確認
                        HtmlData.TextContains(selector: "#DashboardPartLayouts", value: "DashboardPart_7"),
                        // タイトルが表示されていることの確認
                        HtmlData.TextContains(selector: "#DashboardPartLayouts", value: "CustomHtmlLayout(「タイトルを表示する：true」)"),
                        // カスタムHTMLが設定されている
                        HtmlData.TextContains(selector: "#DashboardPartLayouts", value: "<p>Hello,Pleasanter!</p>")))
            };
