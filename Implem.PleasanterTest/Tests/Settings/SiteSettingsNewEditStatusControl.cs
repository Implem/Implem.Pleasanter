...
{
    [Collection(nameof(SiteSettingsNewEditStatusControl))]
    public class SiteSettingsNewEditStatusControl
    {
            ...
            var testParts = new List<TestPart>()
            {
                new TestPart(
                    ...
                    forms: FormsUtilities.Get(
                        new KeyValue("ControlId", "NewStatusControl")),
                ...
                new TestPart(
                    title: "サイト設定 - AddStatusControl",
                    forms: FormsUtilities.Get(
                        new KeyValue("ControlId", "EditStatusControl"),
                        new KeyValue("StatusControlId", "1")),
                    baseTests: BaseData.Tests(
                        JsonData.ExistsOne(
                            method: "Html",
                            target: "#StatusControlDialog"),
