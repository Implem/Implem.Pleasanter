...
{
    [Collection(nameof(SiteSettingsAddProcessValidateInput))]
    public class SiteSettingsAddProcessValidateInput
    {
        ...
        public static IEnumerable<object[]> GetData()
        {
            ...
            {
                new TestPart(
                    title: "サイト設定 - AddProcessValidateInput",
                    forms: FormsUtilities.Get(
                        new KeyValue("ControlId", "AddProcessValidateInput")),
