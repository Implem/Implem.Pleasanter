...
{
    [Collection(nameof(SiteSettingsNewEditReminder))]
    public class SiteSettingsNewEditReminder : IDisposable
    {
        ...
        public SiteSettingsNewEditReminder()
        {
            ...
            var testParts = new List<TestPart>()
            {
                new TestPart(
                    ...
                    forms: FormsUtilities.Get(
                        new KeyValue("ControlId", "NewReminder")),
                ...
                new TestPart(
                    title: "サイト設定 - Reminders",
                    forms: FormsUtilities.Get(
                        new KeyValue("ControlId", "EditReminder"),
                        new KeyValue("ReminderId", "1")),
                    baseTests: BaseData.Tests(
                        JsonData.ExistsOne(
                            method: "Html",
                            target: "#ReminderDialog"),
