...
{
    [Collection(nameof(SiteSettingsOtherMethod))]
    public class SiteSettingsOtherMethod
    {
                ...
                new TestPart(
                    ...
                    baseTests: BaseData.Tests(
                        JsonData.HtmlTextContains(
                            ...
                            selector: "#DateRangeOK",
                            value: "onclick=\"$p.openSetDateRangeOK('ViewFilters__DateA_DateRange','');"),
                        JsonData.ExistsOne(
                            method: "SetMemory",
                            target: "formChanged")),
                ...
                new TestPart(
                    ...
                    baseTests: BaseData.Tests(
                        JsonData.HtmlTextContains(
                            ...
                            selector: "#NumericRangeForm",
                            value: "<button class=\"button button-icon validate button-positive\" type=\"button\" onclick=\"$p.openSetNumericRangeOK('ViewFilters__NumA_NumericRange');\" data-icon=\"ui-icon-arrowreturnthick-1-e\" data-method=\"post\">OK</button>"),
                        JsonData.ExistsOne(
                            method: "SetMemory",
                            target: "formChanged")),
                    userType: UserData.UserTypes.Privileged)
