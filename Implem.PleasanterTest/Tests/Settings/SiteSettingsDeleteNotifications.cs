...
{
    [Collection(nameof(SiteSettingsDeleteNotifications))]
    public class SiteSettingsDeleteNotifications : IDisposable
    {
        private ParameterAccessor.Parts.Notification SavedNotification;

        public SiteSettingsDeleteNotifications()
        {
            ...
            var testParts = new List<TestPart>()
            {
                new TestPart(
                    ...
                    forms: FormsUtilities.Get(
                        new KeyValue("ControlId", "DeleteNotifications"),
