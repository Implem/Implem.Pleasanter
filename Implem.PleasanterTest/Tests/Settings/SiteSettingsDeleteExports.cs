...
{
    [Collection(nameof(SiteSettingsDeleteExports))]
    public class SiteSettingsDeleteExports
    {
            ...
            var testParts = new List<TestPart>()
            {
                new TestPart(
                    ...
                    forms: FormsUtilities.Get(
                        new KeyValue("ControlId", "DeleteExports"),
                        new KeyValue("EditExport", @"[""1""]")),
