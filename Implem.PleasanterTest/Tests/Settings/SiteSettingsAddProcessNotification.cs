...
{
    [Collection(nameof(SiteSettingsAddProcessNotification))]
    public class SiteSettingsAddProcessNotification
    {
        ...
        public static IEnumerable<object[]> GetData()
        {
            ...
            {
                new TestPart(
                    title: "サイト設定 - AddProcessNotification",
                    forms: FormsUtilities.Get(
                        new KeyValue("ControlId", "AddProcessNotification"),
