...
{
    [Collection(nameof(SiteSettingsAddProcessDataChange))]
    public class SiteSettingsAddProcessDataChange
    {
        ...
        public static IEnumerable<object[]> GetData()
        {
            ...
            {
                new TestPart(
                    title: "サイト設定 - AddProcessDataChange",
                    forms: FormsUtilities.Get(
                        new KeyValue("ControlId", "AddProcessDataChange")),
