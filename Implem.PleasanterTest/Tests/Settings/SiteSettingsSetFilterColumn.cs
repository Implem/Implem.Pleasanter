...
{
    [Collection(nameof(SiteSettingsSetFilterColumn))]
    public class SiteSettingsSetFilterColumn
    {
            ...
            var testParts = new List<TestPart>()
            {
                new TestPart(
                    ...
                    forms: FormsUtilities.Get(
                        new KeyValue("ControlId","FilterJoin"),
                        new KeyValue("FilterJoin", $"ClassA~{linkSiteId}")),
                    baseTests: BaseData.Tests(
                        JsonData.ExistsOne(
                            method: "Html",
                            target: "#FilterSourceColumns"),
                        JsonData.ExistsOne(
                            method: "SetMemory",
                            target: "formChanged")),
