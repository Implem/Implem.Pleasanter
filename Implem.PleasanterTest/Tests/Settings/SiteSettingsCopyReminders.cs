...
{
    [Collection(nameof(SiteSettingsCopyReminders))]
    public class SiteSettingsCopyReminders : IDisposable
    {
        ...
        public SiteSettingsCopyReminders()
        {
            ...
            var testParts = new List<TestPart>()
            {
                new TestPart(
                    ...
                    forms: FormsUtilities.Get(
                        new KeyValue("ControlId", "CopyReminders"),
