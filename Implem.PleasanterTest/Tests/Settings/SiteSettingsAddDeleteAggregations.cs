...
{
    [Collection(nameof(SiteSettingsAddDeleteAggregations))]
    public class SiteSettingsAddDeleteAggregations
    {
            ...
            var testParts = new List<TestPart>()
            {
                new TestPart(
                    ...
                    forms: FormsUtilities.Get(
                        new KeyValue("ControlId","AddAggregations"),
                    ...
                    baseTests: BaseData.Tests(
                        ...
                        JsonData.ExistsOne(
                            method: "SetFormData",
                            target: "AggregationDestination"),
                        JsonData.HtmlTextContains("Html", "#AggregationDestination","li.ui-selected", "WBS (件数)")),
