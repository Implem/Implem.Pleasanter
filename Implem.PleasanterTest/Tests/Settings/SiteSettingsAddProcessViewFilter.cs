...
{
    [Collection(nameof(SiteSettingsAddProcessViewFilter))]
    public class SiteSettingsAddProcessViewFilter
    {
        ...
        public static IEnumerable<object[]> GetData()
        {
            ...
            {
                new TestPart(
                    title: "サイト設定 - AddProcessViewFilter",
                    forms: FormsUtilities.Get(
                        new KeyValue("ControlId", "AddProcessViewFilter"),
                        new KeyValue("ProcessId", "1"),
                        new KeyValue("ProcessViewFilterSelector", "UpdatedTime")),
                    baseTests: BaseData.Tests(
                        JsonData.ExistsOne(
                            method: "Append",
                            target: "#ProcessViewFiltersTab .items"),
                        JsonData.ExistsOne(
                            method: "SetMemory",
                            target: "formChanged")),
