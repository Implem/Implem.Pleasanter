...
{
    [Collection(nameof(SiteSettingsFormulaCalculationMethod))]
    public class SiteSettingsFormulaCalculationMethod
    {
        ...
        public static IEnumerable<object[]> GetData()
        {
            ...
            {
                new TestPart(
                    title: "サイト設定 - FormulaCalculationMethod",
                    forms: FormsUtilities.Get(
                        new KeyValue("ControlId", "FormulaCalculationMethod"),
                        new KeyValue("CalculationMethod", "Extended")),
