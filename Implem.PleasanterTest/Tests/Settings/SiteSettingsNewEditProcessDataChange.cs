...
{
    [Collection(nameof(SiteSettingsNewEditProcessDataChange))]
    public class SiteSettingsNewEditProcessDataChange
    {
        ...
        public static IEnumerable<object[]> GetData()
        {
            ...
            {
                new TestPart(
                    title: "サイト設定 - NewEditProcessDataChange",
                    forms: FormsUtilities.Get(
                        new KeyValue("ControlId", "NewProcessDataChange"),
                        new KeyValue("ProcessId", "1")),
                    baseTests: BaseData.Tests(
                        JsonData.ExistsOne(
                            method: "Html",
                            target: "#ProcessDataChangeDialog"),
                        JsonData.ExistsOne(
                            method: "SetMemory",
                            target: "formChanged")),
                ...
                new TestPart(
                    title: "サイト設定 - NewEditProcessDataChange",
                    forms: FormsUtilities.Get(
                        new KeyValue("ControlId", "EditProcessDataChange"),
                        new KeyValue("ProcessId", "1"),
                        new KeyValue("ProcessDataChangeId", "1"),
