            ...
            var testParts = new List<TestPart>()
            {
                new TestPart(
                    ...
                    forms: FormsUtilities.Get(
                        new KeyValue("ControlId", "SearchViewAccessControl"),
                        new KeyValue("ViewId", "1"),
                        new KeyValue("SearchViewAccessControl", "%")),
                    baseTests: BaseData.Tests(
                        JsonData.ExistsOne(
                            method: "Html",
                            target: "#SourceViewAccessControl"),
                        JsonData.ExistsOne(
                            method: "SetValue",
                            target: "#SourceViewAccessControlOffset"),
                        JsonData.ExistsOne(
                            method: "SetMemory",
                            target: "formChanged"),
