...
{
    [Collection(nameof(SiteSettingsMoveUpDownReminders))]
    public class SiteSettingsMoveUpDownReminders : IDisposable
    {
        ...
        public SiteSettingsMoveUpDownReminders()
        {
            ...
            var testParts = new List<TestPart>()
            {
                new TestPart(
                    ...
                    forms: FormsUtilities.Get(
                        new KeyValue("ControlId", "MoveUpReminders"),
                ...
                new TestPart(
                    title: "サイト設定 - Reminders",
                    forms: FormsUtilities.Get(
                        new KeyValue("ControlId", "MoveDownReminders"),
                        new KeyValue("EditReminder", @"[""2""]")),
                    baseTests: BaseData.Tests(
                        JsonData.ExistsOne(
                            method: "Html",
