...
{
    [Collection(nameof(SiteSettingsTestReminders))]
    public class SiteSettingsTestReminders : IDisposable
    {
        ...
        public SiteSettingsTestReminders()
        {
            ...
            var testParts = new List<TestPart>()
            {
                new TestPart(
                    ...
                    forms: FormsUtilities.Get(
                        new KeyValue("ControlId", "TestReminders"),
