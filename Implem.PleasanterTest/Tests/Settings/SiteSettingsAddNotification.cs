...
{
    [Collection(nameof(SiteSettingsAddNotification))]
    public class SiteSettingsAddNotification : IDisposable
    {
        private ParameterAccessor.Parts.Notification SavedNotification;

        public SiteSettingsAddNotification()
        {
            ...
            var testParts = new List<TestPart>()
            {
                new TestPart(
                    ...
                    forms: FormsUtilities.Get(
                        new KeyValue("ControlId", "AddNotification"),
                        new KeyValue("NotificationType", "1"),
                        new KeyValue("NotificationPrefix", ""),
                        new KeyValue("NotificationSubject", "新規追加の通知"),
                        new KeyValue("NotificationAddress", "add.dummy.xunit2@implem.dummy.co.jp"),
