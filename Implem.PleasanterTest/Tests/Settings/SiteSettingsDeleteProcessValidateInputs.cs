...
{
    [Collection(nameof(SiteSettingsDeleteProcessValidateInputs))]
    public class SiteSettingsDeleteProcessValidateInputs
    {
        ...
        public static IEnumerable<object[]> GetData()
        {
            ...
            {
                new TestPart(
                    title: "サイト設定 - DeleteProcessValidateInputs",
                    forms: FormsUtilities.Get(
                        new KeyValue("ControlId", "DeleteProcessValidateInputs"),
