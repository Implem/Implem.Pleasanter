...
{
    [Collection(nameof(SiteSettingsUpdateReminder))]
    public class SiteSettingsUpdateReminder : IDisposable
    {
        ...
        public SiteSettingsUpdateReminder()
        {
            ...
            var testParts = new List<TestPart>()
            {
                new TestPart(
                    ...
                    forms: FormsUtilities.Get(
                        new KeyValue("ControlId", "UpdateReminder"),
                        new KeyValue("ReminderId", "1"),
                        new KeyValue("ReminderType", "1"),
                        new KeyValue("ReminderSubject", "更新リマインダー"),
                        new KeyValue("ReminderBody", "[[Records]]"),
                        new KeyValue("ReminderLine", "[タイトル] --- [担当者] ([状況])"),
                        new KeyValue("ReminderFrom", "update.from.reminder1@dummy.implem.co.jp"),
                        new KeyValue("ReminderTo", "update.to.reminder1@dummy.implem.co.jp"),
