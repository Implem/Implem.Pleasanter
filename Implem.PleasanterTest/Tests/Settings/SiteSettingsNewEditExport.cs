...
{
    [Collection(nameof(SiteSettingsNewEditExport))]
    public class SiteSettingsNewEditExport
    {
            ...
            var testParts = new List<TestPart>()
            {
                new TestPart(
                    ...
                    forms: FormsUtilities.Get(
                        new KeyValue("ControlId", "NewExport")),
                    baseTests: BaseData.Tests(
                        ...
                        JsonData.TextContains(
                            method: "Html",
                            target: "#ExportDialog",
                            value: @"button id=""AddExport""")),
                    userType: UserData.UserTypes.Privileged),
                new TestPart(
                    title: "サイト設定 - Exports",
                    forms: FormsUtilities.Get(
                        new KeyValue("ControlId", "EditExport"),
