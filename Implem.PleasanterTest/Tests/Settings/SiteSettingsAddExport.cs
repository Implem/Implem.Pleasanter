...
{
    [Collection(nameof(SiteSettingsAddExport))]
    public class SiteSettingsAddExport
    {
            ...
            UserModel userModel)
        {
            ...
            var context = ContextData.Get(
                ...
                httpMethod: "POST",
                forms: forms);
            context.SessionData.Add("Export", "{"
                + @"""Header"":true,"
                + @"""Columns"":["
            ...
            var testParts = new List<TestPart>()
            {
                new TestPart(
                    ...
                    forms: FormsUtilities.Get(
                        new KeyValue("ControlId", "AddExport"),
                        new KeyValue("ExportName", "エクスポート新規テスト"),
