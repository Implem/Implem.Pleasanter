...
{
    [Collection(nameof(SiteSettingsMoveUpDownStatusControls))]
    public class SiteSettingsMoveUpDownStatusControls
    {
        ...
        public static IEnumerable<object[]> GetData()
        {
            ...
            {
                new TestPart(
                    title: "サイト設定 - MoveUpDownStatusControls",
                    forms: FormsUtilities.Get(
                        new KeyValue("ControlId", "MoveUpStatusControls"),
                ...
                new TestPart(
                    title: "サイト設定 - MoveUpDownStatusControls",
                    forms: FormsUtilities.Get(
                        new KeyValue("ControlId", "MoveDownStatusControls"),
                        new KeyValue("EditStatusControl", "[\"1\"]")),
                    baseTests: BaseData.Tests(
                        JsonData.ExistsOne(
                            method: "ReplaceAll",
