...
{
    [Collection(nameof(SiteSettingsNewEditProcess))]
    public class SiteSettingsNewEditProcess
    {
        ...
        public static IEnumerable<object[]> GetData()
        {
            ...
            {
                new TestPart(
                    title: "サイト設定 - NewEditProcess",
                    forms: FormsUtilities.Get(
                        new KeyValue("ControlId", "NewProcess")),
                    ...
                    title: "サイト設定 - NewEditProcess",
                    forms: FormsUtilities.Get(
                        new KeyValue("ControlId", "EditProcess"),
