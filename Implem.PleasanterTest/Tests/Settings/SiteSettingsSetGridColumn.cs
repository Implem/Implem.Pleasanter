...
{
    [Collection(nameof(SiteSettingsSetGridColumn))]
    public class SiteSettingsSetGridColumn
    {
        ...
        public static IEnumerable<object[]> GetData()
        {
            ...
            {
                new TestPart(
                    title: "サイト設定 - SetGridColumn",
                    forms: FormsUtilities.Get(
                        new KeyValue("ControlId", "SetGridColumn"),
                        new KeyValue("GridColumnName", "ClassA")),
