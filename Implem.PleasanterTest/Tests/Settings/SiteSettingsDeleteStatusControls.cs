...
{
    [Collection(nameof(SiteSettingsDeleteStatusControls))]
    public class SiteSettingsDeleteStatusControls
    {
        ...
        public static IEnumerable<object[]> GetData()
        {
            ...
            {
                new TestPart(
                    title: "サイト設定 - DeleteStatusControls",
                    forms: FormsUtilities.Get(
                        new KeyValue("ControlId", "DeleteStatusControls"),
