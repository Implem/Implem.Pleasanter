...
{
    [Collection(nameof(SiteSettingsDeleteProcessDataChanges))]
    public class SiteSettingsDeleteProcessDataChanges
    {
        ...
        public static IEnumerable<object[]> GetData()
        {
            ...
            {
                new TestPart(
                    title: "サイト設定 - DeleteProcessDataChanges",
                    forms: FormsUtilities.Get(
                        new KeyValue("ControlId", "DeleteProcessDataChanges"),
