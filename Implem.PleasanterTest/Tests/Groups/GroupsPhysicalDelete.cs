...
{
    [Collection(nameof(GroupsPhysicalDelete))]
    public class GroupsPhysicalDelete
    {
        static string DeletedGroup = "グループ16（物理削除）";
        public GroupsPhysicalDelete()
        {
        ...
        private static string Results(
            Context context)
        {
            return GroupUtilities.PhysicalBulkDelete(
                context: context,
