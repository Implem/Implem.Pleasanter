...
{
    [Collection(nameof(ItemsAnaly))]
    public class ItemsAnaly
    {
        [Theory]
        ...
        public static IEnumerable<object[]> GetData()
        {
            ...
            foreach (var testPart in testParts)
            {
                yield return TestData(
                    ...
                    baseTests: BaseData.Tests(HtmlData.ExistsOne(selector: "#AnalyBody")));
            }
        }
        ...
        private static string Results(Context context)
        {
            ...
            return itemModel.Analy(context: context);
        }
    }
}