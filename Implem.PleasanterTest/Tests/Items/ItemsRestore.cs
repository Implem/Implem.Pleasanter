...
{
    [Collection(nameof(ItemsRestore))]
    public class ItemsRestore
    {
        [Theory]
            ...
            List<BaseTest> baseTests)
        {
            ...
            var context = ContextData.Get(
                ...
                routeData: RouteData.ItemsRestore(id: id),
                httpMethod: "POST",
                forms: forms);
        ...
        public static IEnumerable<object[]> GetData()
        {
            var forms = FormsUtilities.Get(
                new KeyValue("GridCheckedItems", Initializer.Titles
                    .Where(o => o.Key == "RecordToRestore1"
                        || o.Key == "RecordToRestore2")
                    .Select(o => o.Value)
                    .Join()));
            var baseTests = BaseData.Tests(
                ...
                JsonData.Value(
                    method: "Message",
                    value: "{\"Id\":\"BulkRestored\",\"Text\":\"2 件 復元しました。\",\"Css\":\"alert-success\"}"));
        ...
        private static string Results(Context context)
        {
            ...
            return itemModel.Restore(context: context);
        }
