...
{
    [Collection(nameof(ItemsRebuildSearchIndexes))]
    public class ItemsRebuildSearchIndexes
    {
        [Theory]
            ...
            List<BaseTest> baseTests)
        {
            ...
            var context = ContextData.Get(
                ...
                routeData: RouteData.ItemsRebuildSearchIndexes(id: id),
                httpMethod: "POST",
                forms: forms);
        ...
        {
            return Indexes.RebuildSearchIndexes(
                context: context,
