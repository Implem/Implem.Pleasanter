...
{
    [Collection(nameof(ItemsBulkDelete))]
    public class ItemsBulkDelete
    {
        [Theory]
            ...
            List<BaseTest> baseTests)
        {
            ...
            var context = ContextData.Get(
                ...
                routeData: RouteData.ItemsBulkDelete(id: id),
                httpMethod: "POST",
                forms: forms);
        ...
        public static IEnumerable<object[]> GetData()
        {
            var forms = FormsUtilities.Get(
                ...
                new KeyValue("GridCheckedItems", Initializer.Titles
                    .Where(o => o.Key == "RecordToBulkDelete1"
                        || o.Key == "RecordToBulkDelete2")
                    .Select(o => o.Value)
                    .Join()));
            var baseTests = BaseData.Tests(
                ...
                JsonData.Value(
                    method: "Message",
                    value: "{\"Id\":\"BulkDeleted\",\"Text\":\"WBS: 2 件 一括削除しました。\",\"Css\":\"alert-success\"}"));
        ...
        private static string Results(Context context)
        {
            ...
            return itemModel.BulkDelete(context: context);
        }
    }
}
