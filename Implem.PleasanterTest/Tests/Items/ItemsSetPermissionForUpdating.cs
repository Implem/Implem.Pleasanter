    ...
    public class ItemsSetPermissionForUpdating
    {
            ...
            List<BaseTest> baseTests)
        {
            ...
            var context = ContextData.Get(
                ...
                routeData: RouteData.ItemsSetPermissionForUpdating(id: id),
                httpMethod: "POST",
                forms: forms);
        ...
        public static IEnumerable<object[]> GetData()
        {
            var forms = FormsUtilities.Get(
                new KeyValue("ControlId", "ChangePermissionForUpdating"),
                new KeyValue("CurrentPermissionForUpdating", $"[\"Dept,0,1\"]"),
                new KeyValue("CurrentPermissionForUpdatingAll", $"[\"Dept,0,1\"]"),
            ...
            var baseTests = BaseData.Tests(
                ...
                JsonData.ExistsOne(
                    method: "Html",
                    target: "#CurrentPermissionForUpdating"),
                JsonData.ExistsOne(
                    method: "SetData",
                    target: "#CurrentPermissionForUpdating"),
                JsonData.ExistsOne(
        ...
        {
            return PermissionUtilities.SetPermissionForUpdating(
                context: context,
