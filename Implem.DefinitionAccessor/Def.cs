...
namespace Implem.DefinitionAccessor
{
        ...
        public static void SetCodeDefinition()
        {
            ...
            CodeXls.XlsSheet.ForEach(definitionRow =>
            {
                switch (definitionRow[0].ToString())
                {
                    ...
                    case "Model_Utility_Create": Code.Model_Utility_Create = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_Utility_Create, definitionRow, CodeXls); break;
                    case "Model_Utility_CreateParams": Code.Model_Utility_CreateParams = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_Utility_CreateParams, definitionRow, CodeXls); break;
                    case "Model_Utility_CreateParams_Sites": Code.Model_Utility_CreateParams_Sites = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_Utility_CreateParams_Sites, definitionRow, CodeXls); break;
                    case "Model_Utility_ValidateBeforeCreateCases": Code.Model_Utility_ValidateBeforeCreateCases = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_Utility_ValidateBeforeCreateCases, definitionRow, CodeXls); break;
                    case "Model_Utility_CreatedResponse": Code.Model_Utility_CreatedResponse = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_Utility_CreatedResponse, definitionRow, CodeXls); break;
                    case "Model_Utility_CreatedResponse_Sites": Code.Model_Utility_CreatedResponse_Sites = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_Utility_CreatedResponse_Sites, definitionRow, CodeXls); break;
                    case "Model_Utility_Update": Code.Model_Utility_Update = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_Utility_Update, definitionRow, CodeXls); break;
                    case "Model_Utility_Update_NewModel": Code.Model_Utility_Update_NewModel = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_Utility_Update_NewModel, definitionRow, CodeXls); break;
                    case "Model_Utility_Update_NewModel_Sites": Code.Model_Utility_Update_NewModel_Sites = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_Utility_Update_NewModel_Sites, definitionRow, CodeXls); break;
                    case "Model_Utility_UpdateInvalid_Users": Code.Model_Utility_UpdateInvalid_Users = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_Utility_UpdateInvalid_Users, definitionRow, CodeXls); break;
                    case "Model_Utility_ValidateBeforeUpdate_User": Code.Model_Utility_ValidateBeforeUpdate_User = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_Utility_ValidateBeforeUpdate_User, definitionRow, CodeXls); break;
                    case "Model_Utility_ValidateBeforeUpdateCases": Code.Model_Utility_ValidateBeforeUpdateCases = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_Utility_ValidateBeforeUpdateCases, definitionRow, CodeXls); break;
                    case "Model_Utility_OnUpdated_Issues": Code.Model_Utility_OnUpdated_Issues = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_Utility_OnUpdated_Issues, definitionRow, CodeXls); break;
                    case "Model_Utility_OnUpdated_Breadcrumb": Code.Model_Utility_OnUpdated_Breadcrumb = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_Utility_OnUpdated_Breadcrumb, definitionRow, CodeXls); break;
                    ...
                    case "Model_Utility_CanCreate": Code.Model_Utility_CanCreate = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_Utility_CanCreate, definitionRow, CodeXls); break;
                    case "Model_Utility_CanUpdate": Code.Model_Utility_CanUpdate = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_Utility_CanUpdate, definitionRow, CodeXls); break;
                    case "Model_Utility_CanDelete": Code.Model_Utility_CanDelete = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_Utility_CanDelete, definitionRow, CodeXls); break;
                    case "Model_Utility_CanDownLoadFile": Code.Model_Utility_CanDownLoadFile = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_Utility_CanDownLoadFile, definitionRow, CodeXls); break;
                    case "Model_Utility_CanExport": Code.Model_Utility_CanExport = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_Utility_CanExport, definitionRow, CodeXls); break;
                    case "Model_Utility_CanImport": Code.Model_Utility_CanImport = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_Utility_CanImport, definitionRow, CodeXls); break;
                    case "Model_Utility_CanEditSite": Code.Model_Utility_CanEditSite = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_Utility_CanEditSite, definitionRow, CodeXls); break;
                    case "Model_Utility_CanEditPermission": Code.Model_Utility_CanEditPermission = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_Utility_CanEditPermission, definitionRow, CodeXls); break;
                    case "Model_Utility_Self": Code.Model_Utility_Self = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_Utility_Self, definitionRow, CodeXls); break;
    ...
    public class CodeColumn2nd
    {
        ...
        public string Model_Utility_Create;
        public string Model_Utility_CreateParams;
        public string Model_Utility_CreateParams_Sites;
        public string Model_Utility_ValidateBeforeCreateCases;
        public string Model_Utility_CreatedResponse;
        public string Model_Utility_CreatedResponse_Sites;
        public string Model_Utility_Update;
        public string Model_Utility_Update_NewModel;
        public string Model_Utility_Update_NewModel_Sites;
        public string Model_Utility_UpdateInvalid_Users;
        public string Model_Utility_ValidateBeforeUpdate_User;
        public string Model_Utility_ValidateBeforeUpdateCases;
        public string Model_Utility_OnUpdated_Issues;
        public string Model_Utility_OnUpdated_Breadcrumb;
        ...
        public string Model_Utility_CanCreate;
        public string Model_Utility_CanUpdate;
        public string Model_Utility_CanDelete;
        public string Model_Utility_CanDownLoadFile;
        public string Model_Utility_CanExport;
        public string Model_Utility_CanImport;
        public string Model_Utility_CanEditSite;
        public string Model_Utility_CanEditPermission;
        public string Model_Utility_Self;
    ...
    public class CodeTable
    {
        ...
        public CodeDefinition Model_Utility_Create = new CodeDefinition();
        public CodeDefinition Model_Utility_CreateParams = new CodeDefinition();
        public CodeDefinition Model_Utility_CreateParams_Sites = new CodeDefinition();
        public CodeDefinition Model_Utility_ValidateBeforeCreateCases = new CodeDefinition();
        public CodeDefinition Model_Utility_CreatedResponse = new CodeDefinition();
        public CodeDefinition Model_Utility_CreatedResponse_Sites = new CodeDefinition();
        public CodeDefinition Model_Utility_Update = new CodeDefinition();
        public CodeDefinition Model_Utility_Update_NewModel = new CodeDefinition();
        public CodeDefinition Model_Utility_Update_NewModel_Sites = new CodeDefinition();
        public CodeDefinition Model_Utility_UpdateInvalid_Users = new CodeDefinition();
        public CodeDefinition Model_Utility_ValidateBeforeUpdate_User = new CodeDefinition();
        public CodeDefinition Model_Utility_ValidateBeforeUpdateCases = new CodeDefinition();
        public CodeDefinition Model_Utility_OnUpdated_Issues = new CodeDefinition();
        public CodeDefinition Model_Utility_OnUpdated_Breadcrumb = new CodeDefinition();
        ...
        public CodeDefinition Model_Utility_CanCreate = new CodeDefinition();
        public CodeDefinition Model_Utility_CanUpdate = new CodeDefinition();
        public CodeDefinition Model_Utility_CanDelete = new CodeDefinition();
        public CodeDefinition Model_Utility_CanDownLoadFile = new CodeDefinition();
        public CodeDefinition Model_Utility_CanExport = new CodeDefinition();
        public CodeDefinition Model_Utility_CanImport = new CodeDefinition();
        public CodeDefinition Model_Utility_CanEditSite = new CodeDefinition();
        public CodeDefinition Model_Utility_CanEditPermission = new CodeDefinition();
        public CodeDefinition Model_Utility_Self = new CodeDefinition();
