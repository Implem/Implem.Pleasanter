...
namespace Implem.DefinitionAccessor
{
        ...
        public static void SetCodeDefinition()
        {
            ...
            CodeXls.XlsSheet.ForEach(definitionRow =>
            {
                switch (definitionRow[0].ToString())
                {
                    ...
                    case "Model_Utilities_CanCreate": Code.Model_Utilities_CanCreate = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_Utilities_CanCreate, definitionRow, CodeXls); break;
                    case "Model_Utilities_CanUpdate": Code.Model_Utilities_CanUpdate = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_Utilities_CanUpdate, definitionRow, CodeXls); break;
                    case "Model_Utilities_CanDelete": Code.Model_Utilities_CanDelete = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_Utilities_CanDelete, definitionRow, CodeXls); break;
                    case "Model_Utilities_CanDownLoadFile": Code.Model_Utilities_CanDownLoadFile = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_Utilities_CanDownLoadFile, definitionRow, CodeXls); break;
                    case "Model_Utilities_CanExport": Code.Model_Utilities_CanExport = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_Utilities_CanExport, definitionRow, CodeXls); break;
                    case "Model_Utilities_CanImport": Code.Model_Utilities_CanImport = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_Utilities_CanImport, definitionRow, CodeXls); break;
                    case "Model_Utilities_CanEditSite": Code.Model_Utilities_CanEditSite = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_Utilities_CanEditSite, definitionRow, CodeXls); break;
                    case "Model_Utilities_CanEditPermission": Code.Model_Utilities_CanEditPermission = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_Utilities_CanEditPermission, definitionRow, CodeXls); break;
    ...
    public class CodeColumn2nd
    {
        ...
        public string Model_Utilities_CanCreate;
        public string Model_Utilities_CanUpdate;
        public string Model_Utilities_CanDelete;
        public string Model_Utilities_CanDownLoadFile;
        public string Model_Utilities_CanExport;
        public string Model_Utilities_CanImport;
        public string Model_Utilities_CanEditSite;
        public string Model_Utilities_CanEditPermission;
    ...
    public class CodeTable
    {
        ...
        public CodeDefinition Model_Utilities_CanCreate = new CodeDefinition();
        public CodeDefinition Model_Utilities_CanUpdate = new CodeDefinition();
        public CodeDefinition Model_Utilities_CanDelete = new CodeDefinition();
        public CodeDefinition Model_Utilities_CanDownLoadFile = new CodeDefinition();
        public CodeDefinition Model_Utilities_CanExport = new CodeDefinition();
        public CodeDefinition Model_Utilities_CanImport = new CodeDefinition();
        public CodeDefinition Model_Utilities_CanEditSite = new CodeDefinition();
        public CodeDefinition Model_Utilities_CanEditPermission = new CodeDefinition();
