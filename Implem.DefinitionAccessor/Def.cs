...
namespace Implem.DefinitionAccessor
{
        ...
        public static void SetCodeDefinition()
        {
            ...
            CodeXls.XlsSheet.ForEach(definitionRow =>
            {
                switch (definitionRow[0].ToString())
                {
                    ...
                    case "Model_Utility_NewModel": Code.Model_Utility_NewModel = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_Utility_NewModel, definitionRow, CodeXls); break;
                    case "Model_Utility_NewModel_Sites": Code.Model_Utility_NewModel_Sites = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_Utility_NewModel_Sites, definitionRow, CodeXls); break;
    ...
    public class CodeColumn2nd
    {
        ...
        public string Model_Utility_NewModel;
        public string Model_Utility_NewModel_Sites;
    ...
    public class CodeTable
    {
        ...
        public CodeDefinition Model_Utility_NewModel = new CodeDefinition();
        public CodeDefinition Model_Utility_NewModel_Sites = new CodeDefinition();
