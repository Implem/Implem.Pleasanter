...
namespace Implem.DefinitionAccessor
{
        ...
        public static void SetCodeDefinition()
        {
            ...
            CodeXls.XlsSheet.ForEach(definitionRow =>
            {
                switch (definitionRow[0].ToString())
                {
                    ...
                    case "Model_Utilities_FormResponse": Code.Model_Utilities_FormResponse = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_Utilities_FormResponse, definitionRow, CodeXls); break;
                    case "Model_Utilities_FormResponse_ColumnCases": Code.Model_Utilities_FormResponse_ColumnCases = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_Utilities_FormResponse_ColumnCases, definitionRow, CodeXls); break;
                    case "Model_Utilities_FormulaResponse": Code.Model_Utilities_FormulaResponse = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_Utilities_FormulaResponse, definitionRow, CodeXls); break;
                    case "Model_Utilities_FormulaResponse_ColumnCases": Code.Model_Utilities_FormulaResponse_ColumnCases = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_Utilities_FormulaResponse_ColumnCases, definitionRow, CodeXls); break;
                    ...
                    case "Model_Validator_CanCreate": Code.Model_Validator_CanCreate = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_Validator_CanCreate, definitionRow, CodeXls); break;
                    case "Model_Validator_CanUpdate": Code.Model_Validator_CanUpdate = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_Validator_CanUpdate, definitionRow, CodeXls); break;
                    case "Model_Validator_CanDelete": Code.Model_Validator_CanDelete = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_Validator_CanDelete, definitionRow, CodeXls); break;
                    case "Model_Validator_CanDownLoadFile": Code.Model_Validator_CanDownLoadFile = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_Validator_CanDownLoadFile, definitionRow, CodeXls); break;
                    case "Model_Validator_CanExport": Code.Model_Validator_CanExport = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_Validator_CanExport, definitionRow, CodeXls); break;
                    case "Model_Validator_CanImport": Code.Model_Validator_CanImport = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_Validator_CanImport, definitionRow, CodeXls); break;
                    case "Model_Validator_CanEditSite": Code.Model_Validator_CanEditSite = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_Validator_CanEditSite, definitionRow, CodeXls); break;
                    case "Model_Validator_CanEditPermission": Code.Model_Validator_CanEditPermission = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_Validator_CanEditPermission, definitionRow, CodeXls); break;
                    case "Model_Validator_Self": Code.Model_Validator_Self = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_Validator_Self, definitionRow, CodeXls); break;
                    case "Model_Validator_CanEditTenant": Code.Model_Validator_CanEditTenant = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_Validator_CanEditTenant, definitionRow, CodeXls); break;
                    case "Model_Validator_CanEditSys": Code.Model_Validator_CanEditSys = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_Validator_CanEditSys, definitionRow, CodeXls); break;
                    ...
                    case "SiteSettings_GetByItem": Code.SiteSettings_GetByItem = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.SiteSettings_GetByItem, definitionRow, CodeXls); break;
        ...
        public static void SetCssDefinition()
        {
            ...
            CssXls.XlsSheet.ForEach(definitionRow =>
            {
                switch (definitionRow[0].ToString())
                {
                    ...
                    case "_dot_grid_space___space_thead_space___space_tr_space___space_th_colon_first_child": Css._dot_grid_space___space_thead_space___space_tr_space___space_th_colon_first_child = definitionRow[1].ToString(); SetCssTable(CssTable._dot_grid_space___space_thead_space___space_tr_space___space_th_colon_first_child, definitionRow, CssXls); break;
        ...
        public static void SetDisplayDefinition()
        {
            ...
            DisplayXls.XlsSheet.ForEach(definitionRow =>
            {
                switch (definitionRow[0].ToString())
                {
                    ...
                    case "SettingGridFormat": Display.SettingGridFormat = definitionRow[1].ToString(); SetDisplayTable(DisplayTable.SettingGridFormat, definitionRow, DisplayXls); break;
                    ...
                    case "OnOnly": Display.OnOnly = definitionRow[1].ToString(); SetDisplayTable(DisplayTable.OnOnly, definitionRow, DisplayXls); break;
                    case "OnOnly_ja": Display.OnOnly_ja = definitionRow[1].ToString(); SetDisplayTable(DisplayTable.OnOnly_ja, definitionRow, DisplayXls); break;
                    case "OnAndOff": Display.OnAndOff = definitionRow[1].ToString(); SetDisplayTable(DisplayTable.OnAndOff, definitionRow, DisplayXls); break;
                    case "OnAndOff_ja": Display.OnAndOff_ja = definitionRow[1].ToString(); SetDisplayTable(DisplayTable.OnAndOff_ja, definitionRow, DisplayXls); break;
                    case "On": Display.On = definitionRow[1].ToString(); SetDisplayTable(DisplayTable.On, definitionRow, DisplayXls); break;
                    case "On_ja": Display.On_ja = definitionRow[1].ToString(); SetDisplayTable(DisplayTable.On_ja, definitionRow, DisplayXls); break;
                    case "Off": Display.Off = definitionRow[1].ToString(); SetDisplayTable(DisplayTable.Off, definitionRow, DisplayXls); break;
                    case "Off_ja": Display.Off_ja = definitionRow[1].ToString(); SetDisplayTable(DisplayTable.Off_ja, definitionRow, DisplayXls); break;
                    ...
                    case "SecondAgo": Display.SecondAgo = definitionRow[1].ToString(); SetDisplayTable(DisplayTable.SecondAgo, definitionRow, DisplayXls); break;
                    case "SecondAgo_ja": Display.SecondAgo_ja = definitionRow[1].ToString(); SetDisplayTable(DisplayTable.SecondAgo_ja, definitionRow, DisplayXls); break;
                    case "SecondsAgo": Display.SecondsAgo = definitionRow[1].ToString(); SetDisplayTable(DisplayTable.SecondsAgo, definitionRow, DisplayXls); break;
                    case "SecondsAgo_ja": Display.SecondsAgo_ja = definitionRow[1].ToString(); SetDisplayTable(DisplayTable.SecondsAgo_ja, definitionRow, DisplayXls); break;
                    case "MinuteAgo": Display.MinuteAgo = definitionRow[1].ToString(); SetDisplayTable(DisplayTable.MinuteAgo, definitionRow, DisplayXls); break;
                    case "MinuteAgo_ja": Display.MinuteAgo_ja = definitionRow[1].ToString(); SetDisplayTable(DisplayTable.MinuteAgo_ja, definitionRow, DisplayXls); break;
                    case "MinutesAgo": Display.MinutesAgo = definitionRow[1].ToString(); SetDisplayTable(DisplayTable.MinutesAgo, definitionRow, DisplayXls); break;
                    case "MinutesAgo_ja": Display.MinutesAgo_ja = definitionRow[1].ToString(); SetDisplayTable(DisplayTable.MinutesAgo_ja, definitionRow, DisplayXls); break;
                    case "HourAgo": Display.HourAgo = definitionRow[1].ToString(); SetDisplayTable(DisplayTable.HourAgo, definitionRow, DisplayXls); break;
                    case "HourAgo_ja": Display.HourAgo_ja = definitionRow[1].ToString(); SetDisplayTable(DisplayTable.HourAgo_ja, definitionRow, DisplayXls); break;
                    case "HoursAgo": Display.HoursAgo = definitionRow[1].ToString(); SetDisplayTable(DisplayTable.HoursAgo, definitionRow, DisplayXls); break;
                    case "HoursAgo_ja": Display.HoursAgo_ja = definitionRow[1].ToString(); SetDisplayTable(DisplayTable.HoursAgo_ja, definitionRow, DisplayXls); break;
                    case "DayAgo": Display.DayAgo = definitionRow[1].ToString(); SetDisplayTable(DisplayTable.DayAgo, definitionRow, DisplayXls); break;
                    case "DayAgo_ja": Display.DayAgo_ja = definitionRow[1].ToString(); SetDisplayTable(DisplayTable.DayAgo_ja, definitionRow, DisplayXls); break;
                    case "DaysAgo": Display.DaysAgo = definitionRow[1].ToString(); SetDisplayTable(DisplayTable.DaysAgo, definitionRow, DisplayXls); break;
                    case "DaysAgo_ja": Display.DaysAgo_ja = definitionRow[1].ToString(); SetDisplayTable(DisplayTable.DaysAgo_ja, definitionRow, DisplayXls); break;
                    case "MonthAgo": Display.MonthAgo = definitionRow[1].ToString(); SetDisplayTable(DisplayTable.MonthAgo, definitionRow, DisplayXls); break;
                    case "MonthAgo_ja": Display.MonthAgo_ja = definitionRow[1].ToString(); SetDisplayTable(DisplayTable.MonthAgo_ja, definitionRow, DisplayXls); break;
                    case "MonthsAgo": Display.MonthsAgo = definitionRow[1].ToString(); SetDisplayTable(DisplayTable.MonthsAgo, definitionRow, DisplayXls); break;
                    case "MonthsAgo_ja": Display.MonthsAgo_ja = definitionRow[1].ToString(); SetDisplayTable(DisplayTable.MonthsAgo_ja, definitionRow, DisplayXls); break;
                    case "YearAgo": Display.YearAgo = definitionRow[1].ToString(); SetDisplayTable(DisplayTable.YearAgo, definitionRow, DisplayXls); break;
                    case "YearAgo_ja": Display.YearAgo_ja = definitionRow[1].ToString(); SetDisplayTable(DisplayTable.YearAgo_ja, definitionRow, DisplayXls); break;
                    case "YearsAgo": Display.YearsAgo = definitionRow[1].ToString(); SetDisplayTable(DisplayTable.YearsAgo, definitionRow, DisplayXls); break;
                    case "YearsAgo_ja": Display.YearsAgo_ja = definitionRow[1].ToString(); SetDisplayTable(DisplayTable.YearsAgo_ja, definitionRow, DisplayXls); break;
                    ...
                    case "Aggregations": Display.Aggregations = definitionRow[1].ToString(); SetDisplayTable(DisplayTable.Aggregations, definitionRow, DisplayXls); break;
                    ...
                    case "UseFy": Display.UseFy = definitionRow[1].ToString(); SetDisplayTable(DisplayTable.UseFy, definitionRow, DisplayXls); break;
                    case "UseFy_ja": Display.UseFy_ja = definitionRow[1].ToString(); SetDisplayTable(DisplayTable.UseFy_ja, definitionRow, DisplayXls); break;
                    case "UseHalf": Display.UseHalf = definitionRow[1].ToString(); SetDisplayTable(DisplayTable.UseHalf, definitionRow, DisplayXls); break;
                    case "UseHalf_ja": Display.UseHalf_ja = definitionRow[1].ToString(); SetDisplayTable(DisplayTable.UseHalf_ja, definitionRow, DisplayXls); break;
                    case "UseQuarter": Display.UseQuarter = definitionRow[1].ToString(); SetDisplayTable(DisplayTable.UseQuarter, definitionRow, DisplayXls); break;
                    case "UseQuarter_ja": Display.UseQuarter_ja = definitionRow[1].ToString(); SetDisplayTable(DisplayTable.UseQuarter_ja, definitionRow, DisplayXls); break;
                    case "UseMonth": Display.UseMonth = definitionRow[1].ToString(); SetDisplayTable(DisplayTable.UseMonth, definitionRow, DisplayXls); break;
                    case "UseMonth_ja": Display.UseMonth_ja = definitionRow[1].ToString(); SetDisplayTable(DisplayTable.UseMonth_ja, definitionRow, DisplayXls); break;
    ...
    public class CodeColumn2nd
    {
        ...
        public string Model_Utilities_FormResponse;
        public string Model_Utilities_FormResponse_ColumnCases;
        public string Model_Utilities_FormulaResponse;
        public string Model_Utilities_FormulaResponse_ColumnCases;
        ...
        public string Model_Validator_CanCreate;
        public string Model_Validator_CanUpdate;
        public string Model_Validator_CanDelete;
        public string Model_Validator_CanDownLoadFile;
        public string Model_Validator_CanExport;
        public string Model_Validator_CanImport;
        public string Model_Validator_CanEditSite;
        public string Model_Validator_CanEditPermission;
        public string Model_Validator_Self;
        public string Model_Validator_CanEditTenant;
        public string Model_Validator_CanEditSys;
        public string Rds;
        ...
        public string SiteSettings_GetByItem;
    ...
    public class CodeTable
    {
        ...
        public CodeDefinition Model_Utilities_FormResponse = new CodeDefinition();
        public CodeDefinition Model_Utilities_FormResponse_ColumnCases = new CodeDefinition();
        public CodeDefinition Model_Utilities_FormulaResponse = new CodeDefinition();
        public CodeDefinition Model_Utilities_FormulaResponse_ColumnCases = new CodeDefinition();
        ...
        public CodeDefinition Model_Validator_CanCreate = new CodeDefinition();
        public CodeDefinition Model_Validator_CanUpdate = new CodeDefinition();
        public CodeDefinition Model_Validator_CanDelete = new CodeDefinition();
        public CodeDefinition Model_Validator_CanDownLoadFile = new CodeDefinition();
        public CodeDefinition Model_Validator_CanExport = new CodeDefinition();
        public CodeDefinition Model_Validator_CanImport = new CodeDefinition();
        public CodeDefinition Model_Validator_CanEditSite = new CodeDefinition();
        public CodeDefinition Model_Validator_CanEditPermission = new CodeDefinition();
        public CodeDefinition Model_Validator_Self = new CodeDefinition();
        public CodeDefinition Model_Validator_CanEditTenant = new CodeDefinition();
        public CodeDefinition Model_Validator_CanEditSys = new CodeDefinition();
        ...
        public CodeDefinition SiteSettings_GetByItem = new CodeDefinition();
    ...
    public class CssColumn2nd
    {
        ...
        public string _dot_grid_space___space_thead_space___space_tr_space___space_th_colon_first_child;
    ...
    public class CssTable
    {
        ...
        public CssDefinition _dot_grid_space___space_thead_space___space_tr_space___space_th_colon_first_child = new CssDefinition();
    ...
    public class DisplayColumn2nd
    {
        ...
        public string SettingGridFormat;
        ...
        public string OnOnly;
        public string OnOnly_ja;
        public string OnAndOff;
        public string OnAndOff_ja;
        public string On;
        public string On_ja;
        public string Off;
        public string Off_ja;
        ...
        public string SecondAgo_ja;
        public string SecondsAgo;
        public string SecondsAgo_ja;
        public string MinuteAgo;
        public string MinuteAgo_ja;
        public string MinutesAgo;
        public string MinutesAgo_ja;
        public string HourAgo;
        public string HourAgo_ja;
        public string HoursAgo;
        public string HoursAgo_ja;
        public string DayAgo;
        public string DayAgo_ja;
        public string DaysAgo;
        public string DaysAgo_ja;
        public string MonthAgo;
        public string MonthAgo_ja;
        public string MonthsAgo;
        public string MonthsAgo_ja;
        public string YearAgo;
        public string YearAgo_ja;
        public string YearsAgo;
        public string YearsAgo_ja;
        ...
        public string UseFy;
        public string UseFy_ja;
        public string UseHalf;
        public string UseHalf_ja;
        public string UseQuarter;
        public string UseQuarter_ja;
        public string UseMonth;
        public string UseMonth_ja;
        public string Ymd;
    ...
    public class DisplayTable
    {
        ...
        public DisplayDefinition SettingGridFormat = new DisplayDefinition();
        ...
        public DisplayDefinition OnOnly = new DisplayDefinition();
        public DisplayDefinition OnOnly_ja = new DisplayDefinition();
        public DisplayDefinition OnAndOff = new DisplayDefinition();
        public DisplayDefinition OnAndOff_ja = new DisplayDefinition();
        public DisplayDefinition On = new DisplayDefinition();
        public DisplayDefinition On_ja = new DisplayDefinition();
        public DisplayDefinition Off = new DisplayDefinition();
        public DisplayDefinition Off_ja = new DisplayDefinition();
        ...
        public DisplayDefinition SecondAgo = new DisplayDefinition();
        public DisplayDefinition SecondAgo_ja = new DisplayDefinition();
        public DisplayDefinition SecondsAgo = new DisplayDefinition();
        public DisplayDefinition SecondsAgo_ja = new DisplayDefinition();
        public DisplayDefinition MinuteAgo = new DisplayDefinition();
        public DisplayDefinition MinuteAgo_ja = new DisplayDefinition();
        public DisplayDefinition MinutesAgo = new DisplayDefinition();
        public DisplayDefinition MinutesAgo_ja = new DisplayDefinition();
        public DisplayDefinition HourAgo = new DisplayDefinition();
        public DisplayDefinition HourAgo_ja = new DisplayDefinition();
        public DisplayDefinition HoursAgo = new DisplayDefinition();
        public DisplayDefinition HoursAgo_ja = new DisplayDefinition();
        public DisplayDefinition DayAgo = new DisplayDefinition();
        public DisplayDefinition DayAgo_ja = new DisplayDefinition();
        public DisplayDefinition DaysAgo = new DisplayDefinition();
        public DisplayDefinition DaysAgo_ja = new DisplayDefinition();
        public DisplayDefinition MonthAgo = new DisplayDefinition();
        public DisplayDefinition MonthAgo_ja = new DisplayDefinition();
        public DisplayDefinition MonthsAgo = new DisplayDefinition();
        public DisplayDefinition MonthsAgo_ja = new DisplayDefinition();
        public DisplayDefinition YearAgo = new DisplayDefinition();
        public DisplayDefinition YearAgo_ja = new DisplayDefinition();
        public DisplayDefinition YearsAgo = new DisplayDefinition();
        public DisplayDefinition YearsAgo_ja = new DisplayDefinition();
        ...
        public DisplayDefinition Aggregations = new DisplayDefinition();
        ...
        public DisplayDefinition UseFy = new DisplayDefinition();
        public DisplayDefinition UseFy_ja = new DisplayDefinition();
        public DisplayDefinition UseHalf = new DisplayDefinition();
        public DisplayDefinition UseHalf_ja = new DisplayDefinition();
        public DisplayDefinition UseQuarter = new DisplayDefinition();
        public DisplayDefinition UseQuarter_ja = new DisplayDefinition();
        public DisplayDefinition UseMonth = new DisplayDefinition();
        public DisplayDefinition UseMonth_ja = new DisplayDefinition();
