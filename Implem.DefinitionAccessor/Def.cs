...
namespace Implem.DefinitionAccessor
{
        ...
        public static void SetTemplateDefinition()
        {
            ...
            TemplateXls.XlsSheet.ForEach(definitionRow =>
            {
                switch (definitionRow[0].ToString())
                {
                    ...
                    case "Template87": Template.Template87 = definitionRow[1].ToString(); SetTemplateTable(TemplateTable.Template87, definitionRow, TemplateXls); break;
    ...
    public class TemplateTable
    {
        ...
        public TemplateDefinition Template87 = new TemplateDefinition();
