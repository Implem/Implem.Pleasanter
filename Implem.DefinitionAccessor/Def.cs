...
namespace Implem.DefinitionAccessor
{
        ...
        public static void SetCodeDefinition()
        {
            ...
            CodeXls.XlsSheet.ForEach(definitionRow =>
            {
                switch (definitionRow[0].ToString())
                {
                    ...
                    case "Model_InitSiteSettingsParameter": Code.Model_InitSiteSettingsParameter = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_InitSiteSettingsParameter, definitionRow, CodeXls); break;
                    ...
                    case "Model_InitSiteSettings": Code.Model_InitSiteSettings = definitionRow[1].ToString().NoSpace(definitionRow["NoSpace"].ToBool()); SetCodeTable(CodeTable.Model_InitSiteSettings, definitionRow, CodeXls); break;
        ...
        public static void SetDemoDefinition()
        {
            ...
            DemoXls.XlsSheet.ForEach(definitionRow =>
            {
                switch (definitionRow[0].ToString())
                {
                    ...
                    case "Result4": Demo.Result4 = definitionRow[1].ToString(); SetDemoTable(DemoTable.Result4, definitionRow, DemoXls); break;
                    case "Result5": Demo.Result5 = definitionRow[1].ToString(); SetDemoTable(DemoTable.Result5, definitionRow, DemoXls); break;
                    case "Result6": Demo.Result6 = definitionRow[1].ToString(); SetDemoTable(DemoTable.Result6, definitionRow, DemoXls); break;
    ...
    public class CodeColumn2nd
    {
        ...
        public string Model_InitSiteSettingsParameter;
        ...
        public string Model_InitSiteSettings;
    ...
    public class CodeTable
    {
        ...
        public CodeDefinition Model_InitSiteSettingsParameter = new CodeDefinition();
        ...
        public CodeDefinition Model_InitSiteSettings = new CodeDefinition();
    ...
    public class DemoTable
    {
        ...
        public DemoDefinition Result4 = new DemoDefinition();
        public DemoDefinition Result5 = new DemoDefinition();
        public DemoDefinition Result6 = new DemoDefinition();
