...
namespace Implem.DefinitionAccessor
{
        ...
        public static void SetColumnDefinition()
        {
            ...
            ColumnXls.XlsSheet.ForEach(definitionRow =>
            {
                switch (definitionRow[0].ToString())
                {
                    ...
                    case "Tenants_State": Column.Tenants_State = definitionRow[1].ToString(); SetColumnTable(ColumnTable.Tenants_State, definitionRow, ColumnXls); break;
                    case "Tenants_City": Column.Tenants_City = definitionRow[1].ToString(); SetColumnTable(ColumnTable.Tenants_City, definitionRow, ColumnXls); break;
                    case "Tenants_Street": Column.Tenants_Street = definitionRow[1].ToString(); SetColumnTable(ColumnTable.Tenants_Street, definitionRow, ColumnXls); break;
                    case "Tenants_Other": Column.Tenants_Other = definitionRow[1].ToString(); SetColumnTable(ColumnTable.Tenants_Other, definitionRow, ColumnXls); break;
                    case "Tenants_Phone": Column.Tenants_Phone = definitionRow[1].ToString(); SetColumnTable(ColumnTable.Tenants_Phone, definitionRow, ColumnXls); break;
    ...
    public class ColumnColumn2nd
    {
        ...
        public string Tenants_State;
        public string Tenants_City;
        public string Tenants_Street;
        public string Tenants_Other;
        public string Tenants_Phone;
    ...
    public class ColumnTable
    {
        ...
        public ColumnDefinition Tenants_State = new ColumnDefinition();
        public ColumnDefinition Tenants_City = new ColumnDefinition();
        public ColumnDefinition Tenants_Street = new ColumnDefinition();
        public ColumnDefinition Tenants_Other = new ColumnDefinition();
        public ColumnDefinition Tenants_Phone = new ColumnDefinition();
