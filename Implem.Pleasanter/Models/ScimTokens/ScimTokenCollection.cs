...
{
    [Serializable]
    public class ScimTokenCollection : List<ScimTokenModel>
    {
        [NonSerialized]
        public Databases.AccessStatuses AccessStatus = Databases.AccessStatuses.Initialized;
        public int TotalCount;

        public ScimTokenCollection(
            Context context,
        ...
        private ScimTokenCollection Set(
            Context context,
            EnumerableRowCollection<DataRow> dataRows)
        {
            if (dataRows.Any())
