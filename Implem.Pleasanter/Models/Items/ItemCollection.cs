...
namespace Implem.Pleasanter.Models
{
    public class ItemCollection : List<ItemModel>
    {
        ...
        public ItemCollection(EnumerableRowCollection<DataRow> dataRows)
        {
            Set(dataRows);
        }

        private ItemCollection Set(EnumerableRowCollection<DataRow> dataRows)
        {
            if (dataRows.Any())
            {
            ...
            IEnumerable<Aggregation> aggregations = null)
        {
            ...
            {
                statements.AddRange(Rds.ItemsAggregations(aggregations, where));
            }
