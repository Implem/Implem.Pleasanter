...
namespace Implem.Pleasanter.Models
{
    ...
    public class WikiCollection : List<WikiModel>
    {
        ...
        public WikiCollection(Context context,SiteSettings ss,EnumerableRowCollection<DataRow> dataRows)
        {
            Set(context, ss, dataRows);
        }

        private WikiCollection Set(Context context, SiteSettings ss,EnumerableRowCollection<DataRow> dataRows)
        {
            if (dataRows.Any())
            {
