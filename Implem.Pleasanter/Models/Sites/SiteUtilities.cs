                        ...
                        action: () => hb
                            ...
                            .Div(css: "command-center", action: () => hb
                                ...
                                .FieldCheckBox(
                                    ...
                                    _checked: ss.EnableCrosstab == Parameters.General.DefaultCrosstabDisable)
                                .FieldCheckBox(
                                    controlId: "DisableGantt",
                                    fieldCss: "field-auto-thin",
                                    labelText: Displays.DisableGantt(context: context),
                                    _checked: ss.EnableGantt == Parameters.General.DefaultGanttDisable)
                                .FieldCheckBox(
                                    controlId: "DisableBurnDown",
                                    fieldCss: "field-auto-thin",
                                    labelText: Displays.DisableBurnDown(context: context),
                                    _checked: ss.EnableBurnDown == Parameters.General.DefaultBurnDownDisable)
                                .FieldCheckBox(
                                    controlId: "DisableTimeSeries",
                                    fieldCss: "field-auto-thin",
                                    labelText: Displays.DisableTimeSeries(context: context),
                                    _checked: ss.EnableTimeSeries == Parameters.General.DefaultTimeSeriesDisable)
                                .FieldCheckBox(
                                    controlId: "DisableAnaly",
                                    fieldCss: "field-auto-thin",
                                    labelText: Displays.DisableAnaly(context: context),
                                    _checked: ss.EnableAnaly == Parameters.General.DefaultAnalyDisable)
                                .FieldCheckBox(
                                    controlId: "DisableKamban",
                                    fieldCss: "field-auto-thin",
                                    labelText: Displays.DisableKamban(context: context),
                                    _checked: ss.EnableKamban == Parameters.General.DefaultKambanDisable)
                                .FieldCheckBox(
                                    controlId: "DisableImageLib",
                                    fieldCss: "field-auto-thin",
                                    labelText: Displays.DisableImageLib(context: context),
                                    _checked: ss.EnableImageLib == Parameters.General.DefaultImageLibDisable))
                            .P(css: "message-dialog")
                            .Div(css: "command-center", action: () => hb
                                .Button(
