...
namespace Implem.Pleasanter.Models
{
    ...
    public class SearchIndexCollection : List<SearchIndexModel>
    {
        ...
        public SearchIndexCollection(Context context,EnumerableRowCollection<DataRow> dataRows)
        {
            Set(context, dataRows);
        }

        private SearchIndexCollection Set(Context context, EnumerableRowCollection<DataRow> dataRows)
        {
            if (dataRows.Any())
            {
