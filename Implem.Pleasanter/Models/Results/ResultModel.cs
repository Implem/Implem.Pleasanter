...
namespace Implem.Pleasanter.Models
{
    ...
    public class ResultModel : BaseItemModel
    {
            ...
            bool paramAll = false)
        {
            ...
            if (AttachmentsA_Updated()) AttachmentsA.SqlStatements(statements, ResultId);
            if (AttachmentsB_Updated()) AttachmentsB.SqlStatements(statements, ResultId);
            if (AttachmentsC_Updated()) AttachmentsC.SqlStatements(statements, ResultId);
            if (AttachmentsD_Updated()) AttachmentsD.SqlStatements(statements, ResultId);
            if (AttachmentsE_Updated()) AttachmentsE.SqlStatements(statements, ResultId);
            if (AttachmentsF_Updated()) AttachmentsF.SqlStatements(statements, ResultId);
            if (AttachmentsG_Updated()) AttachmentsG.SqlStatements(statements, ResultId);
            if (AttachmentsH_Updated()) AttachmentsH.SqlStatements(statements, ResultId);
            if (AttachmentsI_Updated()) AttachmentsI.SqlStatements(statements, ResultId);
            if (AttachmentsJ_Updated()) AttachmentsJ.SqlStatements(statements, ResultId);
            if (AttachmentsK_Updated()) AttachmentsK.SqlStatements(statements, ResultId);
            if (AttachmentsL_Updated()) AttachmentsL.SqlStatements(statements, ResultId);
            if (AttachmentsM_Updated()) AttachmentsM.SqlStatements(statements, ResultId);
            if (AttachmentsN_Updated()) AttachmentsN.SqlStatements(statements, ResultId);
            if (AttachmentsO_Updated()) AttachmentsO.SqlStatements(statements, ResultId);
            if (AttachmentsP_Updated()) AttachmentsP.SqlStatements(statements, ResultId);
            if (AttachmentsQ_Updated()) AttachmentsQ.SqlStatements(statements, ResultId);
            if (AttachmentsR_Updated()) AttachmentsR.SqlStatements(statements, ResultId);
            if (AttachmentsS_Updated()) AttachmentsS.SqlStatements(statements, ResultId);
            if (AttachmentsT_Updated()) AttachmentsT.SqlStatements(statements, ResultId);
            if (AttachmentsU_Updated()) AttachmentsU.SqlStatements(statements, ResultId);
            if (AttachmentsV_Updated()) AttachmentsV.SqlStatements(statements, ResultId);
            if (AttachmentsW_Updated()) AttachmentsW.SqlStatements(statements, ResultId);
            if (AttachmentsX_Updated()) AttachmentsX.SqlStatements(statements, ResultId);
            if (AttachmentsY_Updated()) AttachmentsY.SqlStatements(statements, ResultId);
            if (AttachmentsZ_Updated()) AttachmentsZ.SqlStatements(statements, ResultId);
            return statements;
        }
