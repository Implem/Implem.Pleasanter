        ...
        public void SetByForm(SiteSettings ss)
        {
            Forms.Keys().ForEach(controlId =>
            {
                switch (controlId)
                {
                    ...
                    case "Results_AttachmentA": AttachmentA = Forms.Data(controlId).ToString(); break;
                    case "Results_AttachmentB": AttachmentB = Forms.Data(controlId).ToString(); break;
                    case "Results_AttachmentC": AttachmentC = Forms.Data(controlId).ToString(); break;
                    case "Results_AttachmentD": AttachmentD = Forms.Data(controlId).ToString(); break;
                    case "Results_AttachmentE": AttachmentE = Forms.Data(controlId).ToString(); break;
                    case "Results_AttachmentF": AttachmentF = Forms.Data(controlId).ToString(); break;
                    case "Results_AttachmentG": AttachmentG = Forms.Data(controlId).ToString(); break;
                    case "Results_AttachmentH": AttachmentH = Forms.Data(controlId).ToString(); break;
                    case "Results_AttachmentI": AttachmentI = Forms.Data(controlId).ToString(); break;
                    case "Results_AttachmentJ": AttachmentJ = Forms.Data(controlId).ToString(); break;
                    case "Results_AttachmentK": AttachmentK = Forms.Data(controlId).ToString(); break;
                    case "Results_AttachmentL": AttachmentL = Forms.Data(controlId).ToString(); break;
                    case "Results_AttachmentM": AttachmentM = Forms.Data(controlId).ToString(); break;
                    case "Results_AttachmentN": AttachmentN = Forms.Data(controlId).ToString(); break;
                    case "Results_AttachmentO": AttachmentO = Forms.Data(controlId).ToString(); break;
                    case "Results_AttachmentP": AttachmentP = Forms.Data(controlId).ToString(); break;
                    case "Results_AttachmentQ": AttachmentQ = Forms.Data(controlId).ToString(); break;
                    case "Results_AttachmentR": AttachmentR = Forms.Data(controlId).ToString(); break;
                    case "Results_AttachmentS": AttachmentS = Forms.Data(controlId).ToString(); break;
                    case "Results_AttachmentT": AttachmentT = Forms.Data(controlId).ToString(); break;
                    case "Results_AttachmentU": AttachmentU = Forms.Data(controlId).ToString(); break;
                    case "Results_AttachmentV": AttachmentV = Forms.Data(controlId).ToString(); break;
                    case "Results_AttachmentW": AttachmentW = Forms.Data(controlId).ToString(); break;
                    case "Results_AttachmentX": AttachmentX = Forms.Data(controlId).ToString(); break;
                    case "Results_AttachmentY": AttachmentY = Forms.Data(controlId).ToString(); break;
                    case "Results_AttachmentZ": AttachmentZ = Forms.Data(controlId).ToString(); break;
