        ...
        public ResultApiModel GetByApi(SiteSettings ss)
        {
            ...
            ss.ReadableColumns().ForEach(column =>
            {
                switch (column.ColumnName)
                {
                    ...
                    case "DateA": data.DateA = DateA; break;
                    case "DateB": data.DateB = DateB; break;
                    case "DateC": data.DateC = DateC; break;
                    case "DateD": data.DateD = DateD; break;
                    case "DateE": data.DateE = DateE; break;
                    case "DateF": data.DateF = DateF; break;
                    case "DateG": data.DateG = DateG; break;
                    case "DateH": data.DateH = DateH; break;
                    case "DateI": data.DateI = DateI; break;
                    case "DateJ": data.DateJ = DateJ; break;
                    case "DateK": data.DateK = DateK; break;
                    case "DateL": data.DateL = DateL; break;
                    case "DateM": data.DateM = DateM; break;
                    case "DateN": data.DateN = DateN; break;
                    case "DateO": data.DateO = DateO; break;
                    case "DateP": data.DateP = DateP; break;
                    case "DateQ": data.DateQ = DateQ; break;
                    case "DateR": data.DateR = DateR; break;
                    case "DateS": data.DateS = DateS; break;
                    case "DateT": data.DateT = DateT; break;
                    case "DateU": data.DateU = DateU; break;
                    case "DateV": data.DateV = DateV; break;
                    case "DateW": data.DateW = DateW; break;
                    case "DateX": data.DateX = DateX; break;
                    case "DateY": data.DateY = DateY; break;
                    case "DateZ": data.DateZ = DateZ; break;
        ...
        public void SetByForm(SiteSettings ss)
        {
            Forms.Keys().ForEach(controlId =>
            {
                switch (controlId)
                {
                    ...
                    case "Results_AttachmentsA": AttachmentsA = new Attachments(Forms.List(controlId)); break;
                    case "Results_AttachmentsB": AttachmentsB = new Attachments(Forms.List(controlId)); break;
                    case "Results_AttachmentsC": AttachmentsC = new Attachments(Forms.List(controlId)); break;
                    case "Results_AttachmentsD": AttachmentsD = new Attachments(Forms.List(controlId)); break;
                    case "Results_AttachmentsE": AttachmentsE = new Attachments(Forms.List(controlId)); break;
                    case "Results_AttachmentsF": AttachmentsF = new Attachments(Forms.List(controlId)); break;
                    case "Results_AttachmentsG": AttachmentsG = new Attachments(Forms.List(controlId)); break;
                    case "Results_AttachmentsH": AttachmentsH = new Attachments(Forms.List(controlId)); break;
                    case "Results_AttachmentsI": AttachmentsI = new Attachments(Forms.List(controlId)); break;
                    case "Results_AttachmentsJ": AttachmentsJ = new Attachments(Forms.List(controlId)); break;
                    case "Results_AttachmentsK": AttachmentsK = new Attachments(Forms.List(controlId)); break;
                    case "Results_AttachmentsL": AttachmentsL = new Attachments(Forms.List(controlId)); break;
                    case "Results_AttachmentsM": AttachmentsM = new Attachments(Forms.List(controlId)); break;
                    case "Results_AttachmentsN": AttachmentsN = new Attachments(Forms.List(controlId)); break;
                    case "Results_AttachmentsO": AttachmentsO = new Attachments(Forms.List(controlId)); break;
                    case "Results_AttachmentsP": AttachmentsP = new Attachments(Forms.List(controlId)); break;
                    case "Results_AttachmentsQ": AttachmentsQ = new Attachments(Forms.List(controlId)); break;
                    case "Results_AttachmentsR": AttachmentsR = new Attachments(Forms.List(controlId)); break;
                    case "Results_AttachmentsS": AttachmentsS = new Attachments(Forms.List(controlId)); break;
                    case "Results_AttachmentsT": AttachmentsT = new Attachments(Forms.List(controlId)); break;
                    case "Results_AttachmentsU": AttachmentsU = new Attachments(Forms.List(controlId)); break;
                    case "Results_AttachmentsV": AttachmentsV = new Attachments(Forms.List(controlId)); break;
                    case "Results_AttachmentsW": AttachmentsW = new Attachments(Forms.List(controlId)); break;
                    case "Results_AttachmentsX": AttachmentsX = new Attachments(Forms.List(controlId)); break;
