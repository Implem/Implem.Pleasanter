                ...
                .Where(o => !o.Linking))
            {
                switch (column.ColumnName)
                {
                    ...
                    case "ScimId":
                        ...
                        break;
                    case "ScimExternalId":
                        if (groupModel.ScimExternalId_Updated(
                            context: context,
                            column: column,
                            copy: copy))
                        {
                        ...
                        break;
                    case "ScimSync":
                        if (groupModel.ScimSync_Updated(
                            context: context,
                            column: column,
                            copy: copy))
                        {
                ...
                .Where(o => !ss.FormulaTarget(o.ColumnName)))
            {
                switch (column.ColumnName)
                {
                    ...
                    case "SynchronizedTime":
                        ...
                        break;
                    case "ScimId":
                        if (groupModel.ScimId_Updated(context: context))
                        {
                            return new ErrorData(
                                context: context,
                                type: Error.Types.HasNotChangeColumnPermission,
                        ...
                        break;
                    case "ScimExternalId":
                        if (groupModel.ScimExternalId_Updated(context: context))
                        {
                            return new ErrorData(
                                context: context,
                                type: Error.Types.HasNotChangeColumnPermission,
                        ...
                        break;
                    case "ScimSync":
                        if (groupModel.ScimSync_Updated(context: context))
                        {
                            return new ErrorData(
                                context: context,
                                type: Error.Types.HasNotChangeColumnPermission,
