...
namespace Implem.Pleasanter.Models
{
    public class GroupCollection : List<GroupModel>
    {
        ...
        public GroupCollection(SiteSettings ss, DataTable dataTable)
        {
            Set(ss, dataTable);
        }

        private GroupCollection Set(SiteSettings ss, DataTable dataTable)
        {
            ...
            IEnumerable<Aggregation> aggregationCollection = null)
        {
            ...
            {
                statements.AddRange(Rds.GroupsAggregations(aggregationCollection, where));
            }
        ...
        private DataTable Get(string commandText, SqlParamCollection param = null)
        {
            return Rds.ExecuteTable(
                transactional: false,
                statements: Rds.GroupsStatement(
