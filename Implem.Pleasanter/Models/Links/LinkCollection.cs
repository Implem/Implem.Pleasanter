...
namespace Implem.Pleasanter.Models
{
    public class LinkCollection : List<LinkModel>
    {
        ...
        public LinkCollection(EnumerableRowCollection<DataRow> dataRows)
        {
            Set(dataRows);
        }

        private LinkCollection Set(EnumerableRowCollection<DataRow> dataRows)
        {
            if (dataRows.Any())
            {
            ...
            IEnumerable<Aggregation> aggregations = null)
        {
            ...
            {
                statements.AddRange(Rds.LinksAggregations(aggregations, where));
            }
