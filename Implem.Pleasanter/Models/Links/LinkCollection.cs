...
namespace Implem.Pleasanter.Models
{
    ...
    public class LinkCollection : List<LinkModel>
    {
        ...
        public LinkCollection(Context context,EnumerableRowCollection<DataRow> dataRows)
        {
            Set(context, dataRows);
        }

        private LinkCollection Set(Context context, EnumerableRowCollection<DataRow> dataRows)
        {
            if (dataRows.Any())
            {
