                ...
                .Where(o => !o.Linking))
            {
                switch (column.ColumnName)
                {
                    ...
                    case "UiType":
                        ...
                        break;
                    case "UiColorScheme":
                        if (tenantModel.UiColorScheme_Updated(
                            context: context,
                            column: column,
                            copy: copy))
                        {
                        ...
                        break;
                    case "UiMainColor":
                        if (tenantModel.UiMainColor_Updated(
                            context: context,
                            column: column,
                            copy: copy))
                        {
                        ...
                        break;
                    case "UiSubColor":
                        if (tenantModel.UiSubColor_Updated(
                            context: context,
                            column: column,
                            copy: copy))
                        {
                    ...
                    case "UiBackgroundColor":
                        if (tenantModel.UiBackgroundColor_Updated(
                            context: context,
                            column: column,
                            copy: copy))
                        {
                    ...
                    case "DeleteRequestTime":
                        if (tenantModel.DeleteRequestTime_Updated(
                            context: context,
                            column: column,
                            copy: copy))
                        {
                ...
                .Where(o => !ss.FormulaTarget(o.ColumnName)))
            {
                switch (column.ColumnName)
                {
                    ...
                    case "TimeZone":
                        ...
                        break;
                    case "UiType":
                        if (tenantModel.UiType_Updated(context: context))
                        {
                            return new ErrorData(
                                context: context,
                                type: Error.Types.HasNotChangeColumnPermission,
                        ...
                        break;
                    case "UiColorScheme":
                        if (tenantModel.UiColorScheme_Updated(context: context))
                        {
                            return new ErrorData(
                                context: context,
                                type: Error.Types.HasNotChangeColumnPermission,
                        ...
                        break;
                    case "UiMainColor":
                        if (tenantModel.UiMainColor_Updated(context: context))
                        {
                            return new ErrorData(
                                context: context,
                                type: Error.Types.HasNotChangeColumnPermission,
                        ...
                        break;
                    case "UiSubColor":
                        if (tenantModel.UiSubColor_Updated(context: context))
                        {
                            return new ErrorData(
                                context: context,
                                type: Error.Types.HasNotChangeColumnPermission,
                        ...
                        break;
                    case "UiBackgroundColor":
                        if (tenantModel.UiBackgroundColor_Updated(context: context))
                        {
                            return new ErrorData(
                                context: context,
                                type: Error.Types.HasNotChangeColumnPermission,
                    ...
                    case "RestartScheduledTime":
                        ...
                        break;
                    case "DeleteRequestTime":
                        if (tenantModel.DeleteRequestTime_Updated(context: context))
                        {
                            return new ErrorData(
                                context: context,
                                type: Error.Types.HasNotChangeColumnPermission,
