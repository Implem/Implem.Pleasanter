...
namespace Implem.Pleasanter.Models
{
    ...
    public class BinaryCollection : List<BinaryModel>
    {
        ...
        public BinaryCollection(Context context,EnumerableRowCollection<DataRow> dataRows)
        {
            Set(context, dataRows);
        }

        private BinaryCollection Set(Context context, EnumerableRowCollection<DataRow> dataRows)
        {
            if (dataRows.Any())
            {
