...
namespace Implem.Pleasanter.Models
{
    public class BinaryCollection : List<BinaryModel>
    {
        ...
        public BinaryCollection(EnumerableRowCollection<DataRow> dataRows)
        {
            Set(dataRows);
        }

        private BinaryCollection Set(EnumerableRowCollection<DataRow> dataRows)
        {
            if (dataRows.Any())
            {
                foreach (DataRow dataRow in dataRows)
                {
                    Add(new BinaryModel(dataRow));
                }
