...
namespace Implem.Pleasanter.Models
{
    ...
    public class SysLogModel : BaseModel
    {
        ...
        public bool SysLogId_InitialValue()
        {
            return SysLogId == 0;
        }

        public bool SysLogType_InitialValue()
        {
            return SysLogType.ToInt() == 0;
        }

        public bool OnAzure_InitialValue()
        {
            return OnAzure == false;
        }

        public bool MachineName_InitialValue()
        {
            return MachineName == string.Empty;
        }

        public bool ServiceName_InitialValue()
        {
        ...
        public bool Application_InitialValue()
        {
            return Application == string.Empty;
        }

        public bool Class_InitialValue()
        {
            return Class == string.Empty;
        }

        public bool Method_InitialValue()
        {
            return Method == string.Empty;
        }

        public bool RequestData_InitialValue()
        {
            return RequestData == string.Empty;
        }

        public bool HttpMethod_InitialValue()
        {
            return HttpMethod == string.Empty;
        }

        public bool RequestSize_InitialValue()
        {
            return RequestSize == 0;
        }

        public bool ResponseSize_InitialValue()
        {
        ...
        public bool ApplicationAge_InitialValue()
        {
            return ApplicationAge == 0;
        }

        public bool ApplicationRequestInterval_InitialValue()
        {
            return ApplicationRequestInterval == 0;
        }

        public bool SessionAge_InitialValue()
        {
            return SessionAge == 0;
        }

        public bool SessionRequestInterval_InitialValue()
        {
            return SessionRequestInterval == 0;
        }

        public bool WorkingSet64_InitialValue()
        {
            return WorkingSet64 == 0;
        }

        public bool VirtualMemorySize64_InitialValue()
        {
            return VirtualMemorySize64 == 0;
        }

        public bool ProcessId_InitialValue()
        {
            return ProcessId == 0;
        }

        public bool ProcessName_InitialValue()
        {
            return ProcessName == string.Empty;
        }

        public bool BasePriority_InitialValue()
        {
            return BasePriority == 0;
        }

        public bool Url_InitialValue()
        {
            return Url == string.Empty;
        }

        public bool UrlReferer_InitialValue()
        {
            return UrlReferer == string.Empty;
        }

        public bool UserHostName_InitialValue()
        {
            return UserHostName == string.Empty;
        }

        public bool UserHostAddress_InitialValue()
        {
            return UserHostAddress == string.Empty;
        }

        public bool UserLanguage_InitialValue()
        {
            return UserLanguage == string.Empty;
        }

        public bool UserAgent_InitialValue()
        {
            return UserAgent == string.Empty;
        }

        public bool SessionGuid_InitialValue()
        {
            return SessionGuid == string.Empty;
        }

        public bool ErrMessage_InitialValue()
        {
            return ErrMessage == string.Empty;
        }

        public bool ErrStackTrace_InitialValue()
        {
            return ErrStackTrace == string.Empty;
        }

        public bool InDebug_InitialValue()
        {
            return InDebug == false;
        }

        public bool AssemblyVersion_InitialValue()
        {
