...
namespace Implem.Pleasanter.Models
{
    public class SysLogCollection : List<SysLogModel>
    {
        ...
        public SysLogCollection(EnumerableRowCollection<DataRow> dataRows)
        {
            Set(dataRows);
        }

        private SysLogCollection Set(EnumerableRowCollection<DataRow> dataRows)
        {
            if (dataRows.Any())
            {
            ...
            IEnumerable<Aggregation> aggregations = null)
        {
            ...
            {
                statements.AddRange(Rds.SysLogsAggregations(aggregations, where));
            }
