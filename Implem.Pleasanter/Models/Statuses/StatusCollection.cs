...
namespace Implem.Pleasanter.Models
{
    ...
    public class StatusCollection : List<StatusModel>
    {
        ...
        public StatusCollection(Context context,EnumerableRowCollection<DataRow> dataRows)
        {
            Set(context, dataRows);
        }

        private StatusCollection Set(Context context, EnumerableRowCollection<DataRow> dataRows)
        {
            if (dataRows.Any())
            {
