...
namespace Implem.Pleasanter.Models
{
    public class OutgoingMailCollection : List<OutgoingMailModel>
    {
        ...
        public OutgoingMailCollection(EnumerableRowCollection<DataRow> dataRows)
        {
            Set(dataRows);
        }

        private OutgoingMailCollection Set(EnumerableRowCollection<DataRow> dataRows)
        {
            if (dataRows.Any())
            {
            ...
            IEnumerable<Aggregation> aggregations = null)
        {
            ...
            {
                statements.AddRange(Rds.OutgoingMailsAggregations(aggregations, where));
            }
