...
namespace Implem.Pleasanter.Models
{
    ...
    public class MailAddressCollection : List<MailAddressModel>
    {
        ...
        public MailAddressCollection(Context context,EnumerableRowCollection<DataRow> dataRows)
        {
            Set(context, dataRows);
        }

        private MailAddressCollection Set(Context context, EnumerableRowCollection<DataRow> dataRows)
        {
            if (dataRows.Any())
            {
