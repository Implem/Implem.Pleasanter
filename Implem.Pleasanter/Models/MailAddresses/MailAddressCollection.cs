...
namespace Implem.Pleasanter.Models
{
    public class MailAddressCollection : List<MailAddressModel>
    {
        ...
        public MailAddressCollection(EnumerableRowCollection<DataRow> dataRows)
        {
            Set(dataRows);
        }

        private MailAddressCollection Set(EnumerableRowCollection<DataRow> dataRows)
        {
            if (dataRows.Any())
            {
            ...
            IEnumerable<Aggregation> aggregations = null)
        {
            ...
            {
                statements.AddRange(Rds.MailAddressesAggregations(aggregations, where));
            }
