...
namespace Implem.Pleasanter.Models
{
    public class GroupMemberCollection : List<GroupMemberModel>
    {
        ...
        public GroupMemberCollection(EnumerableRowCollection<DataRow> dataRows)
        {
            Set(dataRows);
        }

        private GroupMemberCollection Set(EnumerableRowCollection<DataRow> dataRows)
        {
            if (dataRows.Any())
            {
            ...
            IEnumerable<Aggregation> aggregationCollection = null)
        {
            ...
            {
                statements.AddRange(Rds.GroupMembersAggregations(aggregationCollection, where));
            }
        ...
        private EnumerableRowCollection<DataRow> Get(string commandText, SqlParamCollection param = null)
        {
            return Rds.ExecuteTable(
                transactional: false,
                statements: Rds.GroupMembersStatement(
