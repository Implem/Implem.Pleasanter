...
namespace Implem.Pleasanter.Models
{
    ...
    public class ExportSettingCollection : List<ExportSettingModel>
    {
        ...
        public ExportSettingCollection(Context context,EnumerableRowCollection<DataRow> dataRows)
        {
            Set(context, dataRows);
        }

        private ExportSettingCollection Set(Context context, EnumerableRowCollection<DataRow> dataRows)
        {
            if (dataRows.Any())
            {
