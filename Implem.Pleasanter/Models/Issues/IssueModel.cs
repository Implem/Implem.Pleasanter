        ...
        private void Set(SiteSettings ss, DataRow dataRow, string tableAlias = null)
        {
            ...
            foreach(DataColumn dataColumn in dataRow.Table.Columns)
            {
                ...
                switch (column.ColumnName)
                {
                    ...
                    case "CompletionTime": CompletionTime = new CompletionTime(dataRow, column); SavedCompletionTime = CompletionTime.Value; break;
                    case "WorkValue": WorkValue = new WorkValue(dataRow, column); SavedWorkValue = WorkValue.Value; break;
                    case "ProgressRate": ProgressRate = new ProgressRate(dataRow, column); SavedProgressRate = ProgressRate.Value; break;
