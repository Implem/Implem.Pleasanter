...
namespace Implem.Pleasanter.Models
{
    ...
    public class IssueModel : BaseItemModel
    {
        ...
        {
            return StartTime != SavedStartTime && StartTime != null;
        }

        public bool CompletionTime_Updated()
        {
            return CompletionTime.Value != SavedCompletionTime && CompletionTime.Value != null;
        }
        ...
        public IssueApiModel GetByApi(SiteSettings ss)
        {
            ...
            ss.ReadableColumns(noJoined: true).ForEach(column =>
            {
                switch (column.ColumnName)
                {
                    ...
                    case "StartTime": data.StartTime = StartTime; break;
                    case "CompletionTime": data.CompletionTime = CompletionTime.Value; break;
            ...
            bool get = true)
        {
            ...
            if (extendedSqls) statements.OnCreatingExtendedSqls(SiteId, IssueId);
