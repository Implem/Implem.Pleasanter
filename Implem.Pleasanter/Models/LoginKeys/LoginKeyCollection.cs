...
namespace Implem.Pleasanter.Models
{
    public class LoginKeyCollection : List<LoginKeyModel>
    {
        ...
        public LoginKeyCollection(DataTable dataTable)
        {
            Set(dataTable);
        }

        private LoginKeyCollection Set(DataTable dataTable)
        {
            if (dataTable.Rows.Count > 0)
            {
                foreach (DataRow dataRow in dataTable.Rows)
                {
                    Add(new LoginKeyModel(dataRow));
                }
            ...
            IEnumerable<Aggregation> aggregationCollection = null)
        {
            ...
            {
                statements.AddRange(Rds.LoginKeysAggregations(aggregationCollection, where));
            }
        ...
        private DataTable Get(string commandText, SqlParamCollection param = null)
        {
            return Rds.ExecuteTable(
                transactional: false,
                statements: Rds.LoginKeysStatement(
