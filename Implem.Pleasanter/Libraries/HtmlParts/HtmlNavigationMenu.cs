...
namespace Implem.Pleasanter.Libraries.HtmlParts
{
    public static class HtmlNavigationMenu
    {
        ...
        {
            if (context.ThemeVersionEqual1_0())
            {
                                            ...
                                            action: () => hb
                                                ...
                                                .Label(
                                                    ...
                                                    action: () => hb
                                                        ...
                                                        .Span(
                                                            action: () => hb
                                                                .Text(Displays.View(context: context))))
                                                .Div(
                                                    css: "menubox-sub",
                                                    action: () => hb
                                                        .Ul(action: () => hb
                                            ...
                                            action: () => hb
                                                ...
                                                .Label(
                                                    ...
                                                    action: () => hb
                                                        ...
                                                        .Span(
                                                            action: () => hb
                                                                .Text(Displays.Manage(context: context))))
                                                .Div(
                                                    css: "menubox-sub",
                                                    action: () => hb
                                                        .Ul(action: () => hb
                                            ...
                                            action: () => hb
                                                ...
                                                .Label(
                                                    ...
                                                    action: () => hb
                                                        ...
                                                        .Span(
                                                            action: () => hb
                                                                .Text(Displays.HelpMenu(context: context))))
                                                .Div(
                                                    css: "menubox-sub",
                                                    action: () => hb
                                                        .Ul(action: () => hb
                                            ...
                                            action: () => hb
                                                ...
                                                .Label(
                                                    ...
                                                    action: () => hb
                                                        ...
                                                        .Span(
                                                            action: () => hb
                                                                .Text(Displays.UserMenu(context: context))))
                                                .Div(
                                                    css: "menubox-sub",
                                                    action: () => hb
                                                        .Ul(action: () => hb
            ...
            string serverScriptLabelText)
        {
                ...
                && !childMenu)
            {
                return hb
                    .Span(
                        css: menu.Icon,
                        _using: context.ThemeVersionEqual1_0())
                    .Text(text: Text(
                        context: context,
                        ss: ss,
                        menu: menu,
