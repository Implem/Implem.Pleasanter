...
namespace Implem.Pleasanter.Libraries.BackgroundServices
{
    ...
    abstract public class ExecutionTimerBase
    {
        ...
        protected SysLogModel CreateSysLogModel(Context context, string message, [CallerMemberName] string memberName = "")
        {
            return new SysLogModel(
                context: context,
                method: nameof(CreateSysLogModel),
                message: $"{MethodBase.GetCurrentMethod().DeclaringType.FullName}.{memberName} , {message}",
