            ...
            FormData formData)
        {
            formData.Keys.ForEach(key =>
            {
                switch (key)
                {
                    ...
                    case "DataViewFilters_Issues_CheckA": where.Issues_CheckA(formData[key], "t0"); break;
                    case "DataViewFilters_Issues_CheckB": where.Issues_CheckB(formData[key], "t0"); break;
                    case "DataViewFilters_Issues_CheckC": where.Issues_CheckC(formData[key], "t0"); break;
                    case "DataViewFilters_Issues_CheckD": where.Issues_CheckD(formData[key], "t0"); break;
                    case "DataViewFilters_Issues_CheckE": where.Issues_CheckE(formData[key], "t0"); break;
                    case "DataViewFilters_Issues_CheckF": where.Issues_CheckF(formData[key], "t0"); break;
                    case "DataViewFilters_Issues_CheckG": where.Issues_CheckG(formData[key], "t0"); break;
                    case "DataViewFilters_Issues_CheckH": where.Issues_CheckH(formData[key], "t0"); break;
                    ...
                    case "DataViewFilters_Results_CheckA": where.Results_CheckA(formData[key], "t0"); break;
                    case "DataViewFilters_Results_CheckB": where.Results_CheckB(formData[key], "t0"); break;
                    case "DataViewFilters_Results_CheckC": where.Results_CheckC(formData[key], "t0"); break;
                    case "DataViewFilters_Results_CheckD": where.Results_CheckD(formData[key], "t0"); break;
                    case "DataViewFilters_Results_CheckE": where.Results_CheckE(formData[key], "t0"); break;
                    case "DataViewFilters_Results_CheckF": where.Results_CheckF(formData[key], "t0"); break;
                    case "DataViewFilters_Results_CheckG": where.Results_CheckG(formData[key], "t0"); break;
                    case "DataViewFilters_Results_CheckH": where.Results_CheckH(formData[key], "t0"); break;
