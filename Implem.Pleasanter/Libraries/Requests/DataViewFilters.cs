            ...
            FormData formData)
        {
            formData.Keys.ForEach(key =>
            {
                switch (key)
                {
                    ...
                    case "DataViewFilters_Demos_Initialized": if (formData[key].ToBool()) where.Demos_Initialized(formData[key].Value, "t0"); break;
                    ...
                    case "DataViewFilters_SysLogs_OnAzure": if (formData[key].ToBool()) where.SysLogs_OnAzure(formData[key].Value, "t0"); break;
                    case "DataViewFilters_SysLogs_InDebug": if (formData[key].ToBool()) where.SysLogs_InDebug(formData[key].Value, "t0"); break;
                    ...
                    case "DataViewFilters_Users_Disabled": if (formData[key].ToBool()) where.Users_Disabled(formData[key].Value, "t0"); break;
                    case "DataViewFilters_Users_TenantAdmin": if (formData[key].ToBool()) where.Users_TenantAdmin(formData[key].Value, "t0"); break;
                    case "DataViewFilters_Users_ServiceAdmin": if (formData[key].ToBool()) where.Users_ServiceAdmin(formData[key].Value, "t0"); break;
                    case "DataViewFilters_Users_Developer": if (formData[key].ToBool()) where.Users_Developer(formData[key].Value, "t0"); break;
                    ...
                    case "DataViewFilters_Items_UpdateTarget": if (formData[key].ToBool()) where.Items_UpdateTarget(formData[key].Value, "t0"); break;
                    ...
                    case "DataViewFilters_ExportSettings_AddHeader": if (formData[key].ToBool()) where.ExportSettings_AddHeader(formData[key].Value, "t0"); break;
                    ...
                    case "DataViewFilters_Issues_CheckA": if (formData[key].ToBool()) where.Issues_CheckA(formData[key].Value, "t0"); break;
                    case "DataViewFilters_Issues_CheckB": if (formData[key].ToBool()) where.Issues_CheckB(formData[key].Value, "t0"); break;
                    case "DataViewFilters_Issues_CheckC": if (formData[key].ToBool()) where.Issues_CheckC(formData[key].Value, "t0"); break;
                    case "DataViewFilters_Issues_CheckD": if (formData[key].ToBool()) where.Issues_CheckD(formData[key].Value, "t0"); break;
                    case "DataViewFilters_Issues_CheckE": if (formData[key].ToBool()) where.Issues_CheckE(formData[key].Value, "t0"); break;
                    case "DataViewFilters_Issues_CheckF": if (formData[key].ToBool()) where.Issues_CheckF(formData[key].Value, "t0"); break;
                    case "DataViewFilters_Issues_CheckG": if (formData[key].ToBool()) where.Issues_CheckG(formData[key].Value, "t0"); break;
                    case "DataViewFilters_Issues_CheckH": if (formData[key].ToBool()) where.Issues_CheckH(formData[key].Value, "t0"); break;
                    case "DataViewFilters_Issues_CheckI": if (formData[key].ToBool()) where.Issues_CheckI(formData[key].Value, "t0"); break;
                    case "DataViewFilters_Issues_CheckJ": if (formData[key].ToBool()) where.Issues_CheckJ(formData[key].Value, "t0"); break;
                    case "DataViewFilters_Issues_CheckK": if (formData[key].ToBool()) where.Issues_CheckK(formData[key].Value, "t0"); break;
                    case "DataViewFilters_Issues_CheckL": if (formData[key].ToBool()) where.Issues_CheckL(formData[key].Value, "t0"); break;
                    case "DataViewFilters_Issues_CheckM": if (formData[key].ToBool()) where.Issues_CheckM(formData[key].Value, "t0"); break;
                    case "DataViewFilters_Issues_CheckN": if (formData[key].ToBool()) where.Issues_CheckN(formData[key].Value, "t0"); break;
                    case "DataViewFilters_Issues_CheckO": if (formData[key].ToBool()) where.Issues_CheckO(formData[key].Value, "t0"); break;
                    case "DataViewFilters_Issues_CheckP": if (formData[key].ToBool()) where.Issues_CheckP(formData[key].Value, "t0"); break;
                    ...
                    case "DataViewFilters_Results_CheckA": if (formData[key].ToBool()) where.Results_CheckA(formData[key].Value, "t0"); break;
                    case "DataViewFilters_Results_CheckB": if (formData[key].ToBool()) where.Results_CheckB(formData[key].Value, "t0"); break;
                    case "DataViewFilters_Results_CheckC": if (formData[key].ToBool()) where.Results_CheckC(formData[key].Value, "t0"); break;
                    case "DataViewFilters_Results_CheckD": if (formData[key].ToBool()) where.Results_CheckD(formData[key].Value, "t0"); break;
                    case "DataViewFilters_Results_CheckE": if (formData[key].ToBool()) where.Results_CheckE(formData[key].Value, "t0"); break;
                    case "DataViewFilters_Results_CheckF": if (formData[key].ToBool()) where.Results_CheckF(formData[key].Value, "t0"); break;
                    case "DataViewFilters_Results_CheckG": if (formData[key].ToBool()) where.Results_CheckG(formData[key].Value, "t0"); break;
                    case "DataViewFilters_Results_CheckH": if (formData[key].ToBool()) where.Results_CheckH(formData[key].Value, "t0"); break;
                    case "DataViewFilters_Results_CheckI": if (formData[key].ToBool()) where.Results_CheckI(formData[key].Value, "t0"); break;
                    case "DataViewFilters_Results_CheckJ": if (formData[key].ToBool()) where.Results_CheckJ(formData[key].Value, "t0"); break;
                    case "DataViewFilters_Results_CheckK": if (formData[key].ToBool()) where.Results_CheckK(formData[key].Value, "t0"); break;
                    case "DataViewFilters_Results_CheckL": if (formData[key].ToBool()) where.Results_CheckL(formData[key].Value, "t0"); break;
                    case "DataViewFilters_Results_CheckM": if (formData[key].ToBool()) where.Results_CheckM(formData[key].Value, "t0"); break;
                    case "DataViewFilters_Results_CheckN": if (formData[key].ToBool()) where.Results_CheckN(formData[key].Value, "t0"); break;
                    case "DataViewFilters_Results_CheckO": if (formData[key].ToBool()) where.Results_CheckO(formData[key].Value, "t0"); break;
                    case "DataViewFilters_Results_CheckP": if (formData[key].ToBool()) where.Results_CheckP(formData[key].Value, "t0"); break;
