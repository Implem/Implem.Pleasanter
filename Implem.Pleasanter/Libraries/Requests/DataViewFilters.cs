            ...
            FormData formData)
        {
            formData.Keys.ForEach(key =>
            {
                switch (key)
                {
                    ...
                    case "DataViewFilters_Issues_NumI": where.Issues_NumI(formData[key], "t0"); break;
                    case "DataViewFilters_Issues_NumJ": where.Issues_NumJ(formData[key], "t0"); break;
                    case "DataViewFilters_Issues_NumK": where.Issues_NumK(formData[key], "t0"); break;
                    case "DataViewFilters_Issues_NumL": where.Issues_NumL(formData[key], "t0"); break;
                    case "DataViewFilters_Issues_NumM": where.Issues_NumM(formData[key], "t0"); break;
                    case "DataViewFilters_Issues_NumN": where.Issues_NumN(formData[key], "t0"); break;
                    case "DataViewFilters_Issues_NumO": where.Issues_NumO(formData[key], "t0"); break;
                    case "DataViewFilters_Issues_NumP": where.Issues_NumP(formData[key], "t0"); break;
                    ...
                    case "DataViewFilters_Issues_DateI": where.Issues_DateI(formData[key], "t0"); break;
                    case "DataViewFilters_Issues_DateJ": where.Issues_DateJ(formData[key], "t0"); break;
                    case "DataViewFilters_Issues_DateK": where.Issues_DateK(formData[key], "t0"); break;
                    case "DataViewFilters_Issues_DateL": where.Issues_DateL(formData[key], "t0"); break;
                    case "DataViewFilters_Issues_DateM": where.Issues_DateM(formData[key], "t0"); break;
                    case "DataViewFilters_Issues_DateN": where.Issues_DateN(formData[key], "t0"); break;
                    case "DataViewFilters_Issues_DateO": where.Issues_DateO(formData[key], "t0"); break;
                    case "DataViewFilters_Issues_DateP": where.Issues_DateP(formData[key], "t0"); break;
                    ...
                    case "DataViewFilters_Issues_DescriptionI": where.Issues_DescriptionI(formData[key], "t0"); break;
                    case "DataViewFilters_Issues_DescriptionJ": where.Issues_DescriptionJ(formData[key], "t0"); break;
                    case "DataViewFilters_Issues_DescriptionK": where.Issues_DescriptionK(formData[key], "t0"); break;
                    case "DataViewFilters_Issues_DescriptionL": where.Issues_DescriptionL(formData[key], "t0"); break;
                    case "DataViewFilters_Issues_DescriptionM": where.Issues_DescriptionM(formData[key], "t0"); break;
                    case "DataViewFilters_Issues_DescriptionN": where.Issues_DescriptionN(formData[key], "t0"); break;
                    case "DataViewFilters_Issues_DescriptionO": where.Issues_DescriptionO(formData[key], "t0"); break;
                    case "DataViewFilters_Issues_DescriptionP": where.Issues_DescriptionP(formData[key], "t0"); break;
                    ...
                    case "DataViewFilters_Issues_CheckI": if (formData[key].ToBool()) where.Issues_CheckI(formData[key], "t0"); break;
                    case "DataViewFilters_Issues_CheckJ": if (formData[key].ToBool()) where.Issues_CheckJ(formData[key], "t0"); break;
                    case "DataViewFilters_Issues_CheckK": if (formData[key].ToBool()) where.Issues_CheckK(formData[key], "t0"); break;
                    case "DataViewFilters_Issues_CheckL": if (formData[key].ToBool()) where.Issues_CheckL(formData[key], "t0"); break;
                    case "DataViewFilters_Issues_CheckM": if (formData[key].ToBool()) where.Issues_CheckM(formData[key], "t0"); break;
                    case "DataViewFilters_Issues_CheckN": if (formData[key].ToBool()) where.Issues_CheckN(formData[key], "t0"); break;
                    case "DataViewFilters_Issues_CheckO": if (formData[key].ToBool()) where.Issues_CheckO(formData[key], "t0"); break;
                    case "DataViewFilters_Issues_CheckP": if (formData[key].ToBool()) where.Issues_CheckP(formData[key], "t0"); break;
                    ...
                    case "DataViewFilters_Results_NumI": where.Results_NumI(formData[key], "t0"); break;
                    case "DataViewFilters_Results_NumJ": where.Results_NumJ(formData[key], "t0"); break;
                    case "DataViewFilters_Results_NumK": where.Results_NumK(formData[key], "t0"); break;
                    case "DataViewFilters_Results_NumL": where.Results_NumL(formData[key], "t0"); break;
                    case "DataViewFilters_Results_NumM": where.Results_NumM(formData[key], "t0"); break;
                    case "DataViewFilters_Results_NumN": where.Results_NumN(formData[key], "t0"); break;
                    case "DataViewFilters_Results_NumO": where.Results_NumO(formData[key], "t0"); break;
                    case "DataViewFilters_Results_NumP": where.Results_NumP(formData[key], "t0"); break;
                    ...
                    case "DataViewFilters_Results_DateI": where.Results_DateI(formData[key], "t0"); break;
                    case "DataViewFilters_Results_DateJ": where.Results_DateJ(formData[key], "t0"); break;
                    case "DataViewFilters_Results_DateK": where.Results_DateK(formData[key], "t0"); break;
                    case "DataViewFilters_Results_DateL": where.Results_DateL(formData[key], "t0"); break;
                    case "DataViewFilters_Results_DateM": where.Results_DateM(formData[key], "t0"); break;
                    case "DataViewFilters_Results_DateN": where.Results_DateN(formData[key], "t0"); break;
                    case "DataViewFilters_Results_DateO": where.Results_DateO(formData[key], "t0"); break;
                    case "DataViewFilters_Results_DateP": where.Results_DateP(formData[key], "t0"); break;
                    ...
                    case "DataViewFilters_Results_DescriptionI": where.Results_DescriptionI(formData[key], "t0"); break;
                    case "DataViewFilters_Results_DescriptionJ": where.Results_DescriptionJ(formData[key], "t0"); break;
                    case "DataViewFilters_Results_DescriptionK": where.Results_DescriptionK(formData[key], "t0"); break;
                    case "DataViewFilters_Results_DescriptionL": where.Results_DescriptionL(formData[key], "t0"); break;
                    case "DataViewFilters_Results_DescriptionM": where.Results_DescriptionM(formData[key], "t0"); break;
                    case "DataViewFilters_Results_DescriptionN": where.Results_DescriptionN(formData[key], "t0"); break;
                    case "DataViewFilters_Results_DescriptionO": where.Results_DescriptionO(formData[key], "t0"); break;
                    case "DataViewFilters_Results_DescriptionP": where.Results_DescriptionP(formData[key], "t0"); break;
                    ...
                    case "DataViewFilters_Results_CheckI": if (formData[key].ToBool()) where.Results_CheckI(formData[key], "t0"); break;
                    case "DataViewFilters_Results_CheckJ": if (formData[key].ToBool()) where.Results_CheckJ(formData[key], "t0"); break;
                    case "DataViewFilters_Results_CheckK": if (formData[key].ToBool()) where.Results_CheckK(formData[key], "t0"); break;
                    case "DataViewFilters_Results_CheckL": if (formData[key].ToBool()) where.Results_CheckL(formData[key], "t0"); break;
                    case "DataViewFilters_Results_CheckM": if (formData[key].ToBool()) where.Results_CheckM(formData[key], "t0"); break;
                    case "DataViewFilters_Results_CheckN": if (formData[key].ToBool()) where.Results_CheckN(formData[key], "t0"); break;
                    case "DataViewFilters_Results_CheckO": if (formData[key].ToBool()) where.Results_CheckO(formData[key], "t0"); break;
                    case "DataViewFilters_Results_CheckP": if (formData[key].ToBool()) where.Results_CheckP(formData[key], "t0"); break;
