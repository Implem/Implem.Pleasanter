            ...
            if (ColumnSorterHash?.Any() == true)
            {
                ...
                ColumnSorterHash?.ForEach(data =>
                {
                    switch (ss.ReferenceType + "_" + data.Key)
                    {
                        ...
                        case "Issues_AttachmentA": orderBy.Issues_AttachmentA(data.Value); break;
                        case "Issues_AttachmentB": orderBy.Issues_AttachmentB(data.Value); break;
                        case "Issues_AttachmentC": orderBy.Issues_AttachmentC(data.Value); break;
                        case "Issues_AttachmentD": orderBy.Issues_AttachmentD(data.Value); break;
                        case "Issues_AttachmentE": orderBy.Issues_AttachmentE(data.Value); break;
                        case "Issues_AttachmentF": orderBy.Issues_AttachmentF(data.Value); break;
                        case "Issues_AttachmentG": orderBy.Issues_AttachmentG(data.Value); break;
                        case "Issues_AttachmentH": orderBy.Issues_AttachmentH(data.Value); break;
                        case "Issues_AttachmentI": orderBy.Issues_AttachmentI(data.Value); break;
                        case "Issues_AttachmentJ": orderBy.Issues_AttachmentJ(data.Value); break;
                        case "Issues_AttachmentK": orderBy.Issues_AttachmentK(data.Value); break;
                        case "Issues_AttachmentL": orderBy.Issues_AttachmentL(data.Value); break;
                        case "Issues_AttachmentM": orderBy.Issues_AttachmentM(data.Value); break;
                        case "Issues_AttachmentN": orderBy.Issues_AttachmentN(data.Value); break;
                        case "Issues_AttachmentO": orderBy.Issues_AttachmentO(data.Value); break;
                        case "Issues_AttachmentP": orderBy.Issues_AttachmentP(data.Value); break;
                        case "Issues_AttachmentQ": orderBy.Issues_AttachmentQ(data.Value); break;
                        case "Issues_AttachmentR": orderBy.Issues_AttachmentR(data.Value); break;
                        case "Issues_AttachmentS": orderBy.Issues_AttachmentS(data.Value); break;
                        case "Issues_AttachmentT": orderBy.Issues_AttachmentT(data.Value); break;
                        case "Issues_AttachmentU": orderBy.Issues_AttachmentU(data.Value); break;
                        case "Issues_AttachmentV": orderBy.Issues_AttachmentV(data.Value); break;
                        case "Issues_AttachmentW": orderBy.Issues_AttachmentW(data.Value); break;
                        case "Issues_AttachmentX": orderBy.Issues_AttachmentX(data.Value); break;
                        case "Issues_AttachmentY": orderBy.Issues_AttachmentY(data.Value); break;
                        case "Issues_AttachmentZ": orderBy.Issues_AttachmentZ(data.Value); break;
                        ...
                        case "Results_AttachmentA": orderBy.Results_AttachmentA(data.Value); break;
                        case "Results_AttachmentB": orderBy.Results_AttachmentB(data.Value); break;
                        case "Results_AttachmentC": orderBy.Results_AttachmentC(data.Value); break;
                        case "Results_AttachmentD": orderBy.Results_AttachmentD(data.Value); break;
                        case "Results_AttachmentE": orderBy.Results_AttachmentE(data.Value); break;
                        case "Results_AttachmentF": orderBy.Results_AttachmentF(data.Value); break;
                        case "Results_AttachmentG": orderBy.Results_AttachmentG(data.Value); break;
                        case "Results_AttachmentH": orderBy.Results_AttachmentH(data.Value); break;
                        case "Results_AttachmentI": orderBy.Results_AttachmentI(data.Value); break;
                        case "Results_AttachmentJ": orderBy.Results_AttachmentJ(data.Value); break;
                        case "Results_AttachmentK": orderBy.Results_AttachmentK(data.Value); break;
                        case "Results_AttachmentL": orderBy.Results_AttachmentL(data.Value); break;
                        case "Results_AttachmentM": orderBy.Results_AttachmentM(data.Value); break;
                        case "Results_AttachmentN": orderBy.Results_AttachmentN(data.Value); break;
                        case "Results_AttachmentO": orderBy.Results_AttachmentO(data.Value); break;
                        case "Results_AttachmentP": orderBy.Results_AttachmentP(data.Value); break;
                        case "Results_AttachmentQ": orderBy.Results_AttachmentQ(data.Value); break;
                        case "Results_AttachmentR": orderBy.Results_AttachmentR(data.Value); break;
                        case "Results_AttachmentS": orderBy.Results_AttachmentS(data.Value); break;
                        case "Results_AttachmentT": orderBy.Results_AttachmentT(data.Value); break;
                        case "Results_AttachmentU": orderBy.Results_AttachmentU(data.Value); break;
                        case "Results_AttachmentV": orderBy.Results_AttachmentV(data.Value); break;
                        case "Results_AttachmentW": orderBy.Results_AttachmentW(data.Value); break;
                        case "Results_AttachmentX": orderBy.Results_AttachmentX(data.Value); break;
                        case "Results_AttachmentY": orderBy.Results_AttachmentY(data.Value); break;
                        case "Results_AttachmentZ": orderBy.Results_AttachmentZ(data.Value); break;
