    ...
    public class View
    {
        ...
        private void SetColumnsWhere(SiteSettings ss, SqlWhereCollection where, string tableName)
        {
            ...
            ColumnFilterHash?
                ...
                .ForEach(data =>
                {
                    ...
                    {
                        CsNumericColumns(tableName, data.Column, "SiteId", data.Value, where);
                    }
                    else
                    {
                        switch (data.Column.TypeName.CsTypeSummary())
                        {
                            case Types.CsBool:
                                CsBoolColumns(
                                    tableName, data.Column, data.ColumnName, data.Value, where);
                                break;
                            ...
                            case Types.CsString:
                                CsStringColumns(
                                    tableName, data.Column, data.Value, where);
                                break;
                        }
                    }
                });
            ...
            SqlWhereCollection where)
        {
            ...
            if (param.Any())
            {
                ...
                {
                    CsNumericRangeColumns(tableName, column, columnName, param, where);
                }
                else
                {
                    CsNumericColumns(tableName, column, columnName, param, where);
                }
            }
        }
            ...
            SqlWhereCollection where)
        {
            if (param.Any())
            {
                where.Add(or: new SqlWhereCollection(
                    CsNumericColumnsWhere(tableName, columnName, param),
                    CsNumericColumnsWhereNull(tableName, column, columnName, param)));
            }
        }

        private SqlWhere CsNumericColumnsWhere(
            string tableName, string columnName, List<string> param)
        {
        ...
        private SqlWhere CsNumericColumnsWhereNull(
            string tableName, Column column, string columnName, List<string> param)
        {
            return param.Any(o => o == "\t")
            ...
            SqlWhereCollection where)
        {
            ...
            {
                where.Add(or: new SqlWhereCollection(
                    CsDateTimeColumnsWhere(tableName, columnName, param),
                    CsDateTimeColumnsWhereNull(tableName, column, columnName, param)));
            }
        }
        ...
        private void CsStringColumns(
            string tableName, Column column, string value, SqlWhereCollection where)
        {
            if (column.HasChoices())
            {
                ...
                {
                    where.Add(or: new SqlWhereCollection(
                        CsStringColumnsWhere(tableName, column.ColumnName, param),
                        CsStringColumnsWhereNull(tableName, column.ColumnName, param)));
                }
            }
            else
            {
            ...
            if (ColumnSorterHash?.Any() == true)
            {
                ...
                ColumnSorterHash?.ForEach(data =>
                {
                    switch (ss.ReferenceType + "_" + data.Key)
                    {
                        ...
                        case "Users_GlobalId": orderBy.Users_GlobalId(data.Value); break;
                        ...
                        case "Issues_AttachmentsA": orderBy.Issues_AttachmentsA(data.Value); break;
                        case "Issues_AttachmentsB": orderBy.Issues_AttachmentsB(data.Value); break;
                        case "Issues_AttachmentsC": orderBy.Issues_AttachmentsC(data.Value); break;
                        case "Issues_AttachmentsD": orderBy.Issues_AttachmentsD(data.Value); break;
                        case "Issues_AttachmentsE": orderBy.Issues_AttachmentsE(data.Value); break;
                        case "Issues_AttachmentsF": orderBy.Issues_AttachmentsF(data.Value); break;
                        case "Issues_AttachmentsG": orderBy.Issues_AttachmentsG(data.Value); break;
                        case "Issues_AttachmentsH": orderBy.Issues_AttachmentsH(data.Value); break;
                        case "Issues_AttachmentsI": orderBy.Issues_AttachmentsI(data.Value); break;
                        case "Issues_AttachmentsJ": orderBy.Issues_AttachmentsJ(data.Value); break;
                        case "Issues_AttachmentsK": orderBy.Issues_AttachmentsK(data.Value); break;
                        case "Issues_AttachmentsL": orderBy.Issues_AttachmentsL(data.Value); break;
                        case "Issues_AttachmentsM": orderBy.Issues_AttachmentsM(data.Value); break;
                        case "Issues_AttachmentsN": orderBy.Issues_AttachmentsN(data.Value); break;
                        case "Issues_AttachmentsO": orderBy.Issues_AttachmentsO(data.Value); break;
                        case "Issues_AttachmentsP": orderBy.Issues_AttachmentsP(data.Value); break;
                        case "Issues_AttachmentsQ": orderBy.Issues_AttachmentsQ(data.Value); break;
                        case "Issues_AttachmentsR": orderBy.Issues_AttachmentsR(data.Value); break;
                        case "Issues_AttachmentsS": orderBy.Issues_AttachmentsS(data.Value); break;
                        case "Issues_AttachmentsT": orderBy.Issues_AttachmentsT(data.Value); break;
                        case "Issues_AttachmentsU": orderBy.Issues_AttachmentsU(data.Value); break;
                        case "Issues_AttachmentsV": orderBy.Issues_AttachmentsV(data.Value); break;
                        case "Issues_AttachmentsW": orderBy.Issues_AttachmentsW(data.Value); break;
                        case "Issues_AttachmentsX": orderBy.Issues_AttachmentsX(data.Value); break;
                        case "Issues_AttachmentsY": orderBy.Issues_AttachmentsY(data.Value); break;
                        case "Issues_AttachmentsZ": orderBy.Issues_AttachmentsZ(data.Value); break;
                        ...
                        case "Results_AttachmentsA": orderBy.Results_AttachmentsA(data.Value); break;
                        case "Results_AttachmentsB": orderBy.Results_AttachmentsB(data.Value); break;
                        case "Results_AttachmentsC": orderBy.Results_AttachmentsC(data.Value); break;
                        case "Results_AttachmentsD": orderBy.Results_AttachmentsD(data.Value); break;
                        case "Results_AttachmentsE": orderBy.Results_AttachmentsE(data.Value); break;
                        case "Results_AttachmentsF": orderBy.Results_AttachmentsF(data.Value); break;
                        case "Results_AttachmentsG": orderBy.Results_AttachmentsG(data.Value); break;
                        case "Results_AttachmentsH": orderBy.Results_AttachmentsH(data.Value); break;
                        case "Results_AttachmentsI": orderBy.Results_AttachmentsI(data.Value); break;
                        case "Results_AttachmentsJ": orderBy.Results_AttachmentsJ(data.Value); break;
                        case "Results_AttachmentsK": orderBy.Results_AttachmentsK(data.Value); break;
                        case "Results_AttachmentsL": orderBy.Results_AttachmentsL(data.Value); break;
                        case "Results_AttachmentsM": orderBy.Results_AttachmentsM(data.Value); break;
                        case "Results_AttachmentsN": orderBy.Results_AttachmentsN(data.Value); break;
                        case "Results_AttachmentsO": orderBy.Results_AttachmentsO(data.Value); break;
                        case "Results_AttachmentsP": orderBy.Results_AttachmentsP(data.Value); break;
                        case "Results_AttachmentsQ": orderBy.Results_AttachmentsQ(data.Value); break;
                        case "Results_AttachmentsR": orderBy.Results_AttachmentsR(data.Value); break;
                        case "Results_AttachmentsS": orderBy.Results_AttachmentsS(data.Value); break;
                        case "Results_AttachmentsT": orderBy.Results_AttachmentsT(data.Value); break;
                        case "Results_AttachmentsU": orderBy.Results_AttachmentsU(data.Value); break;
                        case "Results_AttachmentsV": orderBy.Results_AttachmentsV(data.Value); break;
                        case "Results_AttachmentsW": orderBy.Results_AttachmentsW(data.Value); break;
                        case "Results_AttachmentsX": orderBy.Results_AttachmentsX(data.Value); break;
                        case "Results_AttachmentsY": orderBy.Results_AttachmentsY(data.Value); break;
                        case "Results_AttachmentsZ": orderBy.Results_AttachmentsZ(data.Value); break;
