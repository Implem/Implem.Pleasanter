    ...
    public class Lookup
    {
            ...
            DashboardModel dashboardModel)
        {
            ...
            if (column?.CanRead(
                context: context,
                ss: ss,
                mine: dashboardModel.Mine(context: context)) == true)
            {
                switch (column.ColumnName)
                {
                    case "SiteId":
                        return dashboardModel.SiteId.ToLookup(
                            context: context,
                            ss: ss,
                            column: column,
                            type: Type);
                    case "UpdatedTime":
                        return dashboardModel.UpdatedTime.ToLookup(
                            context: context,
                            ss: ss,
                            column: column,
                            type: Type);
                    case "DashboardId":
                        return dashboardModel.DashboardId.ToLookup(
                            context: context,
                            ss: ss,
                            column: column,
                            type: Type);
                    case "Ver":
                        return dashboardModel.Ver.ToLookup(
                            context: context,
                            ss: ss,
                            column: column,
                            type: Type);
                    case "Title":
                        return dashboardModel.Title.ToLookup(
                            context: context,
                            ss: ss,
                            column: column,
                            type: Type);
                    case "Body":
                        return dashboardModel.Body.ToLookup(
                            context: context,
                            ss: ss,
                            column: column,
                            type: Type);
                    case "TitleBody":
                        return dashboardModel.TitleBody.ToLookup(
                            context: context,
                            ss: ss,
                            column: column,
                            type: Type);
                    ...
                    case "SiteTitle":
                        return dashboardModel.SiteTitle.ToLookup(
                            ...
                            type: Type);
                    case "Comments":
                        return dashboardModel.Comments.ToLookup(
                            context: context,
                            ss: ss,
                            column: column,
                            type: Type);
                    case "Creator":
                        return dashboardModel.Creator.ToLookup(
                            context: context,
                            ss: ss,
                            column: column,
                            type: Type);
                    case "Updator":
                        return dashboardModel.Updator.ToLookup(
                            context: context,
                            ss: ss,
                            column: column,
                            type: Type);
                    case "CreatedTime":
                        return dashboardModel.CreatedTime.ToLookup(
                            context: context,
                            ss: ss,
                            column: column,
                            type: Type);
                    case "VerUp":
                        return dashboardModel.VerUp.ToLookup(
                            context: context,
                            ss: ss,
                            column: column,
                            type: Type);
                    case "Timestamp":
                        return dashboardModel.Timestamp.ToLookup(
                            context: context,
                            ss: ss,
                            column: column,
                            type: Type);
                    default:
                        ...
                        {
                            case "Class":
                                return dashboardModel.GetClass(column: column).ToLookup(
                                    context: context,
                                    ss: ss,
                                    column: column,
                                    type: Type);
                            case "Num":
                                return dashboardModel.GetNum(column: column).ToLookup(
                                    context: context,
                                    ss: ss,
                                    column: column,
                                    type: Type);
                            case "Date":
                                return dashboardModel.GetDate(column: column).ToLookup(
                                    context: context,
                                    ss: ss,
                                    column: column,
                                    type: Type);
                            case "Description":
                                return dashboardModel.GetDescription(column: column).ToLookup(
                                    context: context,
                                    ss: ss,
                                    column: column,
                                    type: Type);
                            case "Check":
                                return dashboardModel.GetCheck(column: column).ToLookup(
                                    context: context,
                                    ss: ss,
                                    column: column,
                                    type: Type);
                            case "Attachments":
                                return dashboardModel.GetAttachments(column: column).ToLookup(
                                    context: context,
                                    ss: ss,
                                    column: column,
                                    type: Type);
