$p.display = function (defaultId) {
    var displays = {
        ...
        ResetIndexView: 'Resetting &quot;Filters&quot; and &quot;Sorters&quot; because the reference site has been changed.',
        ResetIndexView_zh: '由于参考网站已更改，正在重置“过滤器”和“排序器”。',
        ResetIndexView_ja: '基準となるサイトが変更されるため、「フィルタ」および「ソータ」をリセットします。',
        ResetIndexView_de: 'Zur&#252;cksetzen von &quot;Filtern&quot; und &quot;Sortierern&quot;, da sich die Referenzseite ge&#228;ndert hat.',
        ResetIndexView_ko: '기준 사이트가 변경되었기 때문에 &quot;필터&quot;와 &quot;소터&quot;를 재설정합니다.',
        ResetIndexView_es: 'Restableciendo &quot;Filtros&quot; y &quot;Ordenadores&quot; porque el sitio de referencia ha cambiado.',
        ResetIndexView_vn: 'Đặt lại &quot;Bộ lọc&quot; v&#224; &quot;Bộ sắp xếp&quot; v&#236; trang tham chiếu đ&#227; được thay đổi.',
